...
import { BybitWhaleRadarWidget, BybitWhaleScreen, BybitCoinBadge, computeTopTraderDetermination, fetchBybitBatch } from "./components/BybitWhaleComponents";
...
const CRYPTO_COINS = [
  ...
  ["1000PEPE-USDT", "1000 Pepe"], ["FET-USDT", "Fetch.ai"], ["RENDER-USDT", "Render"], ["SHIB-USDT", "Shiba Inu"],
  ...
  ["GRT-USDT", "The Graph"], ["AAVE-USDT", "Aave"], ["ALGO-USDT", "Algorand"],
  ...
  ["NEO-USDT", "Neo"], ["IOTA-USDT", "IOTA"], ["XMR-USDT", "Monero"],
  ...
  ["W-USDT", "Wormhole"], ["ENA-USDT", "Ethena"], ["10000SATS-USDT", "10000 Sats"], ["BOME-USDT", "Book of Meme"],
  ...
  ["PIXEL-USDT", "Pixels"], ["PORTAL-USDT", "Portal"], ["XAI-USDT", "Xai"],
  ["ACE-USDT", "Fusionist"], ["ZETA-USDT", "ZetaChain"], ["DYM-USDT", "Dymension"], ["MAVIA-USDT", "Heroes of Mavia"],
  ["AEVO-USDT", "Aevo"], ["ETHFI-USDT", "ether.fi"], ["METIS-USDT", "Metis"],
  ["ONDO-USDT", "Ondo"], ["CORE-USDT", "Core"],
  ["TNSR-USDT", "Tensor"], ["SAGA-USDT", "Saga"], ["TAIKO-USDT", "Taiko"], ["ZK-USDT", "ZKsync"],
  ["IO-USDT", "IO.NET"], ["ATH-USDT", "Aethir"], ["ZRO-USDT", "LayerZero"],
  ...
  ["FARTCOIN-USDT", "Fartcoin"], ["TRUMP-USDT", "Official Trump"], ["MELANIA-USDT", "Melania Trump"],
  ["SPX-USDT", "SPX6900"], ["1000000MOG-USDT", "Mog Coin"], ["POPCAT-USDT", "Popcat"], ["BRETT-USDT", "Brett"],
  ["1000TURBO-USDT", "1000 Turbo"], ["1000000BABYDOGE-USDT", "1M Baby Doge"],
  ["ZIG-USDT", "Zignaly"],
  ["STEEM-USDT", "Steem"], ["HIVE-USDT", "Hive"], ["WAXP-USDT", "WAX"],
  ["MTL-USDT", "Metal DAO"], ["UMA-USDT", "UMA"], ["BAND-USDT", "Band Protocol"],
  ["NMR-USDT", "Numeraire"], ["TRB-USDT", "Tellor"], ["API3-USDT", "API3"], ["DIA-USDT", "DIA"],
  ["ANKR-USDT", "Ankr"], ["RLC-USDT", "iExec RLC"],
  ["GLM-USDT", "Golem"], ["STORJ-USDT", "Storj"], ["SC-USDT", "Siacoin"], ["AR-USDT", "Arweave"],
  ["LPT-USDT", "Livepeer"], ["ENS-USDT", "Ethereum Name Service"], ["ID-USDT", "SPACE ID"],
  ["HFT-USDT", "Hashflow"], ["GMT-USDT", "STEPN"],
  ["SLP-USDT", "Smooth Love Potion"], ["ILV-USDT", "Illuvium"], ["YGG-USDT", "Yield Guild Games"], ["MAGIC-USDT", "Magic"],
  ["ENJ-USDT", "Enjin Coin"], ["OG-USDT", "OG Fan Token"],
  ["ASTR-USDT", "Astar"], ["GLMR-USDT", "Moonbeam"], ["CFX-USDT", "Conflux"], ["STG-USDT", "Stargate Finance"],
  ["MASK-USDT", "Mask Network"], ["LRC-USDT", "Loopring"],
  ["AKT-USDT", "Akash Network"], ["GOAT-USDT", "Goatseus Maximus"],
  ["MOODENG-USDT", "Moo Deng"], ["PNUT-USDT", "Peanut the Squirrel"], ["ACT-USDT", "AI Prophecy"], ["VIRTUAL-USDT", "Virtuals Protocol"],
  ["WLD-USDT", "Worldcoin"], ["AERO-USDT", "Aerodrome"], ["DEEP-USDT", "DeepBook"],
  ["RAYDIUM-USDT", "Raydium"], ["MOVE-USDT", "Movement"], ["ME-USDT", "Magic Eden"], ["SAFE-USDT", "Safe"],
  ["PENGU-USDT", "Pudgy Penguins"], ["KAIA-USDT", "Kaia"], ["PUMPFUN-USDT", "Pump.fun"],
  ["CITY-USDT", "Manchester City Fan Token"], ["PSG-USDT", "Paris Saint-Germain Fan Token"], ["JUV-USDT", "Juventus Fan Token"],
  ["ASR-USDT", "AS Roma Fan Token"], ["ALPINE-USDT", "BWT Alpine F1 Team Fan Token"]
].map(([symbol, name]) => ({
  symbol, name, price: 0, change: 0, volume: 0, sector: "Crypto", exchange: "Bybit"
}));

export const BYBIT_VERIFIED_SYMBOLS = new Set(CRYPTO_COINS.map(c => c.symbol));
...
export const REALISTIC_CRYPTO_PRICES: Record<string, number> = {
  "BTC-USDT": 80977.85, "ETH-USDT": 2379.84, "SOL-USDT": 185.00, "BNB-USDT": 615.00,
  "SUI-USDT": 0.86, "AVAX-USDT": 42.50, "XRP-USDT": 0.58, "ADA-USDT": 0.42,
  "DOGE-USDT": 0.18, "NEAR-USDT": 4.80, "APT-USDT": 8.20, "LINK-USDT": 14.50,
  "DOT-USDT": 6.20, "PEPE-USDT": 0.0000085, "1000PEPE-USDT": 0.085, "SHIB-USDT": 0.000018,
  "RENDER-USDT": 5.40, "FET-USDT": 1.20, "LTC-USDT": 85.00, "BCH-USDT": 380.00,
  "UNI-USDT": 9.50, "ARB-USDT": 0.55, "TIA-USDT": 5.10, "OP-USDT": 1.45,
  "INJ-USDT": 19.50, "STX-USDT": 1.85, "FIL-USDT": 3.80, "ATOM-USDT": 4.50,
  "IMX-USDT": 1.40, "KAS-USDT": 0.12, "HBAR-USDT": 0.06, "ETC-USDT": 20.50,
  "ICP-USDT": 8.80, "RUNE-USDT": 4.20, "TAO-USDT": 480.00, "SEI-USDT": 0.38,
  "JUP-USDT": 0.85, "WIF-USDT": 1.65, "1000FLOKI-USDT": 0.16, "1000BONK-USDT": 0.022,
  "ORDI-USDT": 35.00, "GALA-USDT": 0.022, "VET-USDT": 0.028, "GRT-USDT": 0.18,
  "AAVE-USDT": 160.00, "ALGO-USDT": 0.14, "ENA-USDT": 0.55, "ONDO-USDT": 0.92,
  "WLD-USDT": 1.85, "CORE-USDT": 0.95, "NOT-USDT": 0.0075, "STRK-USDT": 0.42,
  "PYTH-USDT": 0.35, "JTO-USDT": 2.80, "HYPE-USDT": 22.50, "TRUMP-USDT": 16.50
};

export const REAL_CRYPTO_LIVE_PRICES: Record<string, { price: number; change: number; source: string }> = {};
...
"DOGE-USDT": { rsi: 58, macd: 0.85, fibLevel: "0.618", patternScore: 88, pattern: "1S Hacim Patlaması & Golden Cross ✦✦", potential: 88 },
...
"LTC-USDT": { rsi: 54, macd: 0.8, fibLevel: "0.5", patternScore: 94, pattern: "Halving Support Rally ✦", potential: 94 },
"BCH-USDT": { rsi: 57, macd: 1.0, fibLevel: "0.618", patternScore: 95, pattern: "Channel Re-Test ✦", potential: 95 },
"STX-USDT": { rsi: 58, macd: 1.2, fibLevel: "0.618", patternScore: 96, pattern: "Bitcoin L2 Momentum ✦", potential: 96 },
"FIL-USDT": { rsi: 52, macd: 0.7, fibLevel: "0.5", patternScore: 92, pattern: "Storage Sector Support ✦", potential: 92 },
"ATOM-USDT": { rsi: 53, macd: 0.75, fibLevel: "0.5", patternScore: 93, pattern: "Interchain Expansion ✦", potential: 93 },
"ICP-USDT": { rsi: 56, macd: 1.1, fibLevel: "0.618", patternScore: 95, pattern: "AI Cloud Breakout ✦", potential: 95 },
"ETC-USDT": { rsi: 51, macd: 0.6, fibLevel: "0.382", patternScore: 90, pattern: "Support Bounce ✦", potential: 90 },
"SEI-USDT": { rsi: 60, macd: 1.3, fibLevel: "0.786", patternScore: 97, pattern: "Parallel EVM Momentum ✦✦", potential: 97 },
"WIF-USDT": { rsi: 63, macd: 1.5, fibLevel: "0.786", patternScore: 98, pattern: "Meme Sector Leader ✦✦", potential: 98 },
"1000FLOKI-USDT": { rsi: 61, macd: 1.2, fibLevel: "0.618", patternScore: 96, pattern: "Volume Surge ✦", potential: 96 },
"1000BONK-USDT": { rsi: 59, macd: 1.1, fibLevel: "0.618", patternScore: 95, pattern: "Solana Ecosystem Rally ✦", potential: 95 },
"ORDI-USDT": { rsi: 57, macd: 1.25, fibLevel: "0.618", patternScore: 96, pattern: "Ordinals Breakout ✦", potential: 96 },
"ONDO-USDT": { rsi: 62, macd: 1.4, fibLevel: "0.786", patternScore: 98, pattern: "RWA Narrative Rally ✦✦", potential: 98 },
"TAO-USDT": { rsi: 64, macd: 1.7, fibLevel: "0.786", patternScore: 99, pattern: "Subnet Expansion ✦✦", potential: 99 },
"GRT-USDT": { rsi: 55, macd: 0.9, fibLevel: "0.5", patternScore: 94, pattern: "Indexing Protocol Surge ✦", potential: 94 },
};

function generateCandleData(basePrice: number, periods = 60, symbol = "GENERIC", tf = "1S") {
  const data: any[] = [];
  const validBasePrice = Number.isFinite(basePrice) && basePrice > 0 ? basePrice : 100;
  ...
  // Backwards simulation so that data[periods - 1].price exactly matches validBasePrice
  const rawPrices: number[] = new Array(periods);
  rawPrices[periods - 1] = validBasePrice;
  for (let i = periods - 2; i >= 0; i--) {
    const timeVar = (i + symSeed + tfSeed * 100);
    const wave = Math.sin(timeVar * 0.15) * 0.008 + Math.cos(timeVar * 0.4) * 0.004;
    const trend = i > 30 ? 0.001 : -0.001;
    rawPrices[i] = rawPrices[i + 1] / (1 + trend + wave);
  }

  for (let i = 0; i < periods; i++) {
    const p = rawPrices[i];
    const timeVar = (i + symSeed + tfSeed * 100);
    const high = p * (1 + Math.abs(Math.sin(timeVar * 0.8)) * 0.015);
    const low = p * (1 - Math.abs(Math.cos(timeVar * 0.6)) * 0.015);
    const open = i > 0 ? rawPrices[i - 1] : p * (1 + (Math.sin(timeVar * 1.2)) * 0.005);
    ...
    data.push({
      ...
      candle: [+Math.min(open, p).toFixed(precision), +Math.max(open, p).toFixed(precision)],
  ...
  // Calculate EMA 50 with standard SMA warm-up
  const k50 = 2 / (50 + 1);
  let initialSeed50 = 0;
  const seedCount = Math.min(data.length, 20);
  for (let i = 0; i < seedCount; i++) {
    initialSeed50 += data[i].price;
  }
  let currEma50 = initialSeed50 / seedCount;

  for (let i = 0; i < data.length; i++) {
    currEma50 = data[i].price * k50 + currEma50 * (1 - k50);
    data[i].ema50 = +currEma50.toFixed(precision);
  }
...
export const BYBIT_TOP100_RATIOS: Record<string, { 
  buyRatio: number; 
  sellRatio: number; 
...
export function getTop100TraderRatio(symbol: string, liveChange = 0) {
  const clean = symbol.replace("-USDT", "").replace("USDT", "").replace("-", "").toUpperCase();
  const direct = BYBIT_TOP100_RATIOS[symbol] || BYBIT_TOP100_RATIOS[clean] || BYBIT_TOP100_RATIOS[`${clean}USDT`];
  if (direct) return direct;

  const seed = getSymbolSeed(symbol);
  let buyRatio = 54 + (liveChange * 1.5) + ((seed % 15) - 7);
  buyRatio = Math.max(28, Math.min(84, Math.round(buyRatio * 10) / 10));
  const sellRatio = Math.round((100 - buyRatio) * 10) / 10;
  const det = computeTopTraderDetermination(buyRatio, sellRatio, liveChange);
  return {
    buyRatio,
    sellRatio,
    ...
    isWhaleShort: det.type === "WHALE_SHORT_BIAS" || sellRatio >= 50.0
  };
}
...
export async function fetchRealBybitTechnicals(symbol: string, onUpdate?: () => void): Promise<any> {
  if (!symbol || !symbol.includes("-USDT")) return null;

  // 1. Check local cache (30s)
  const cached = REAL_TECHNICALS_CACHE[symbol];
  if (cached && cached.timestamp && (Date.now() - cached.timestamp < 30000)) {
    return cached;
  }

  // 2. Try fast server-side Bybit technicals endpoint
  try {
    const apiRes = await fetch(`/api/crypto/technicals?symbol=${encodeURIComponent(symbol)}`, {
      signal: AbortSignal.timeout(3000)
    });
    if (apiRes.ok) {
      const result = await apiRes.json();
      if (result && result.ema7 !== undefined) {
    ...
    // Continue to direct Bybit client fetch
  }

  // 3. Direct Client-side fetch: 100% Bybit v5 API (Linear & Spot with native CORS)
  const cleanSym = symbol.replace("-USDT", "USDT");
  const candidates = [cleanSym];
  if (cleanSym === "SHIBUSDT") candidates.push("SHIB1000USDT");
  if (cleanSym === "1000SHIBUSDT") candidates.push("SHIBUSDT");
  if (cleanSym === "1000PEPEUSDT") candidates.push("PEPEUSDT");
  if (cleanSym === "PEPEUSDT") candidates.push("1000PEPEUSDT");
  if (cleanSym === "RAYUSDT") candidates.push("RAYDIUMUSDT");
  if (cleanSym === "TURBOUSDT") candidates.push("1000TURBOUSDT");
  if (cleanSym === "MOGUSDT") candidates.push("1000000MOGUSDT");
  if (cleanSym === "BABYDOGEUSDT") candidates.push("1000000BABYDOGEUSDT");
  if (cleanSym === "BONKUSDT") candidates.push("1000BONKUSDT");
  if (cleanSym === "FLOKIUSDT") candidates.push("1000FLOKIUSDT");
        ...
        try {
          ...
          if (res.ok) {
            ...
            if (Array.isArray(list) && list.length >= 20) {
              ...
              const closes = sorted.map((k: any) => parseFloat(k[4])).filter((n: number) => !isNaN(n));
              const highs = sorted.map((k: any) => parseFloat(k[2])).filter((n: number) => !isNaN(n));
              const lows = sorted.map((k: any) => parseFloat(k[3])).filter((n: number) => !isNaN(n));
              ...
              if (closes.length >= 20) {
                ...
                // 1H Bybit confirmation (interval=60)
                let bullish1hCount = 0;
                let is1hConfirmed = false;
                try {
                  const url1h = url.replace("interval=240", "interval=60").replace("limit=150", "limit=60");
                  const ctrl1h = new AbortController();
                  const tId1h = setTimeout(() => ctrl1h.abort(), 1800);
                  const res1h = await fetch(url1h, { signal: ctrl1h.signal });
                  clearTimeout(tId1h);
                  if (res1h.ok) {
                    const d1h = await res1h.json();
                    const list1h = d1h.result?.list;
                ...
                } else if (emaBullish && bullishHours > 48) {
                  pattern = `⚠️ 4S Matür/Doygun Trend (${bullishHours}S > 48S)`;
                } else if (rsi < 35) {
                ...
                if (emaCrossedUp && is1hConfirmed) {
                  ...
                  patternScore = 65;
                } else if (isFreshBullish && is1hConfirmed && rsi >= 45 && rsi <= 68) {
                  patternScore = 94;
                } else if (isFreshBullish && is1hConfirmed) {
                  patternScore = 88;
                } else if (isFreshBullish && !is1hConfirmed) {
                  ...
                  patternScore = Math.max(30, 48 - Math.round(bearishHours / 4));
                ...
                const isAboveFib618 = ratio >= 0.55;

                const klines = sorted.slice(-50).map((k: any, idx: number) => {
                  const fullIdx = sorted.length - 50 + idx;
                ...
                const result = {
                  ...
                  isAboveFib618,
                  pattern,
                  patternScore: emaCrossedUp ? 98 : (isFreshBullish ? 95 : patternScore),
                  isRealData: true,
                  timeframe: "4S",
                  ema7,
                  ema21,
                  ...
                  potential: emaCrossedUp ? 98 : (isFreshBullish ? 95 : patternScore),
                  klines,
                  source: "BYBIT",
                  timestamp: Date.now()
                };
...
export const fetchRealBinanceTechnicals = fetchRealBybitTechnicals;
...
const getAdjustedTechnicals = (symbol: string, liveChange: number) => {
  ...
  pd.emaBullish = isUp;
  pd.emaCrossedUp = false; // Never claim unverified Golden Cross
  pd.bullishHours = isUp ? 8 : 0;
  pd.isFreshBullish = isUp;
  pd.is1HConfirmedMin2H = isUp && liveChange > 1.5;
  
  return pd;
};

const ASSET_SCORE_CACHE = new Map<string, any>();
const MAX_ASSET_SCORE_CACHE = 1000;
...
const calculateAssetScore = (s: any, currentPrices: any) => {
  ...
  const cacheKey = `${s.symbol}_${roundedChange}`;

  const cached = ASSET_SCORE_CACHE.get(cacheKey);
  ...
  // 10 4-Saatlik (4S) Teknik İndikatör + 1 FIB Seviye Çizelgesi (Toplam 11 Eşit Ağırlıklı Bileşen)
  
  // 1. RSI (14) - 4S: Ideal momentum (48-68) -> 92, Oversold (<35) -> 86, Overbought (>72) -> 52
  let scoreRsi = 70;
  ...
  // 2. MACD (12, 26, 9) - 4S: Strong positive MACD -> 94, Positive -> 85, Negative -> 50
  let scoreMacd = 60;
  ...
  // 3. EMA (7/21 Golden Cross / Dizilim) - 4S (Onaylı)
  let scoreEma = 45;
  const bHours = pd.bullishHours ?? 0;
  const isFresh = pd.isFreshBullish ?? (pd.emaBullish && bHours <= 48);
  const is15mOnay = pd.is15mConfirmed ?? pd.is1HConfirmedMin2H ?? true;

  if (pd.emaCrossedUp && is15mOnay) {
    scoreEma = 98; // Fresh 4S EMA 7/21 Bullish Golden Cross
  } else if (pd.emaCrossedUp && !is15mOnay) {
    scoreEma = 65; // 4S Golden Cross but confirmation pending
  } else if (isFresh && is15mOnay) {
    scoreEma = macd > 0 ? 92 : 84; // EMA 7 > 21 Bullish Trend + confirmation
  } else if (isFresh && !is15mOnay) {
    scoreEma = 60; // 4S Bullish Trend but confirmation pending
  } else if (pd.emaBullish && bHours > 48) {
    scoreEma = 52; // Mature trend (>48h)
  } else {
    scoreEma = 42; // EMA 7 < 21 Bearish Alignment
  }

  // 4. SMA (50/200 Trend Alignment) - 4S
  let scoreSma = pScore >= 90 ? 92 : (pScore >= 75 ? 82 : 62);

  // 5. Bollinger Bands (%B Expansion) - 4S
  let scoreBB = liveChange > 2 ? 96 : (liveChange > 0 ? 84 : 65);

  // 6. Stochastic RSI (Momentum) - 4S
  let scoreStochRsi = (rsi >= 42 && rsi <= 68) ? 92 : (rsi < 35 ? 85 : 58);

  // 7. ADX (14) & DI+ (Trend Strength) - 4S
  let scoreAdx = (pScore >= 88 || Math.abs(liveChange) > 2) ? 92 : 72;

  // 8. CCI (20) (Channel Index) - 4S
  let scoreCci = (macd > 0.3 || liveChange > 1) ? 90 : 65;

  // 9. SuperTrend (4S)
  let scoreSuperTrend = (macd > 0.2 && rsi >= 45) ? 94 : 60;

  // 10. Volume & OBV Flow - 4S
  let scoreVolume = liveChange > 3 ? 96 : (liveChange > 1 ? 90 : (liveChange >= 0 ? 78 : 55));

  // 11. Fibonacci (FIB) Level Chart - 4S
  const isAboveFib618 = pd.isAboveFib618 ?? (fib === "0.618" || fib === "0.786");
  let scoreFib = 70;
  if (fib === "0.618" || fib === "0.786") scoreFib = 96;
  else if (fib === "0.5") scoreFib = 82;
  else if (fib === "0.382") scoreFib = 68;
  else scoreFib = 55;

  // 12. Bybit V5 Top 100 Traders Balina L/S Oranı (4S)
  const isCryptoAsset = s.symbol.includes("USDT");
  const topTraderRatio = isCryptoAsset ? getTop100TraderRatio(s.symbol, liveChange) : null;
  let scoreWhale = 70;
  let whaleStatus = "Nötr";

  if (topTraderRatio) {
    if (topTraderRatio.isShortSqueeze) {
      scoreWhale = 98; // ⚡ Squeeze Avı: Balinalar short yığılmasında, yukarı sert patlama
      whaleStatus = `⚡ Top 100 Squeeze (%${topTraderRatio.sellRatio} Short Avı)`;
    } else if (topTraderRatio.isStrongWhaleLong) {
      scoreWhale = 94; // 🟢 Güçlü Long Birikimi
      whaleStatus = `🟢 Top 100 Güçlü Long (%${topTraderRatio.buyRatio} Long)`;
    } else if (topTraderRatio.isOverLong) {
      scoreWhale = 48; // ⚠️ Aşırı Long Doygunluğu - Düzeltme Riski
      whaleStatus = `⚠️ Top 100 Aşırı Long (%${topTraderRatio.buyRatio} Doygun)`;
    } else if (topTraderRatio.isWhaleShort || topTraderRatio.sellRatio >= 54.0) {
      scoreWhale = 25; // 🔴 Ayı / Ağır Short Baskısı (Örn: HMSTR %69.2 Short)
      whaleStatus = `🔴 Top 100 Balina Short Baskısı (%${topTraderRatio.sellRatio} Short)`;
    } else if (topTraderRatio.sellRatio >= 50.0) {
      scoreWhale = 40; // 🔴 Hafif Short Baskısı
      whaleStatus = `🔴 Top 100 Hafif Short Baskısı (%${topTraderRatio.sellRatio} Short)`;
    } else {
      scoreWhale = 68;
      whaleStatus = `⚖️ Top 100 Dengeli (%${topTraderRatio.buyRatio}L / %${topTraderRatio.sellRatio}S)`;
    }
  } else {
    scoreWhale = liveChange > 1.5 ? 92 : (liveChange >= 0 ? 80 : 58);
    whaleStatus = liveChange > 1.5 ? "Kurumsal Para Girişi" : "Nötr Kurumsal Akış";
  }

  const indicatorBreakdown = [
    { name: "RSI (14)", score: scoreRsi, weight: "%8.33", status: rsi >= 45 ? "Güçlü Momentum" : "Aşırı Satım/Nötr" },
    { name: "MACD (12,26,9)", score: scoreMacd, weight: "%8.33", status: macd > 0 ? "Pozitif Kesişim" : "Negatif Bölge" },
    { name: "EMA (7/21)", score: scoreEma, weight: "%8.33", status: pd.emaCrossedUp ? (is15mOnay ? "🔥 4S Golden Cross (Onaylı)" : "⚠️ Onay Bekleniyor") : (isFresh ? (is15mOnay ? `4S EMA 7 > 21 (${bHours}S)` : "⚠️ Onay Bekleniyor") : (pd.emaBullish ? `⚠️ 4S Matür Trend (${bHours}S > 48S)` : "4S EMA 7 < 21 Düzeltme Modu")) },
    { name: "SMA (50/200)", score: scoreSma, weight: "%8.33", status: pScore >= 80 ? "SMA50 Üzerinde" : "SMA200 Testi" },
    { name: "Bollinger Bantları", score: scoreBB, weight: "%8.33", status: liveChange > 0 ? "Üst Bant Genişlemesi" : "Bant İçi Sıkışma" },
    { name: "Stochastic RSI", score: scoreStochRsi, weight: "%8.33", status: rsi >= 40 ? "Alım Bölgesinde" : "Doygunluk" },
    { name: "ADX & DI+", score: scoreAdx, weight: "%8.33", status: pScore >= 85 ? "Güçlü Trend" : "Zayıf Trend" },
    { name: "CCI (20)", score: scoreCci, weight: "%8.33", status: macd > 0.3 ? "Kanal Kırılımı" : "Yatay Seyir" },
    { name: "SuperTrend (4S)", score: scoreSuperTrend, weight: "%8.33", status: macd > 0.2 ? "Boğa Sinyali Aktif" : "Ayı Bölgesi" },
    { name: "Hacim & OBV", score: scoreVolume, weight: "%8.33", status: liveChange > 1 ? "Hacim Girişi Var" : "Düşük Hacim" },
    { name: "Fibonacci Çizelgesi", score: scoreFib, weight: "%8.33", status: isAboveFib618 ? "🎯 Fib %61.8 Üzerinde Onaylı" : `FIB ${fib} Seviyesi` },
    { name: isCryptoAsset ? "Top 100 Balina L/S" : "Kurumsal Akış", score: scoreWhale, weight: "%8.33", status: whaleStatus }
  ];

  // EQUAL WEIGHTING: Sum divided by 12
  ...
  // Kesin Filtre: Skor 80'in üzerinde olan ve kriptoda balina short baskısı altında OLMAYAN adaylar long için öne çıkarılır (isEligible = true)
  const hasWhaleShort = Boolean(isCryptoAsset && topTraderRatio && (topTraderRatio.isWhaleShort || topTraderRatio.sellRatio >= 50.0));
  const isEligible = techScore >= 80 && !hasWhaleShort;
  ...
  const calculatedShortScore = hasWhaleShort ? Math.min(99, Math.round(techScore * 0.8 + 25)) : Math.round(techScore * 0.8);
  ...
  const result = {
    ...
    longScore: hasWhaleShort ? Math.round(techScore * 0.7) : techScore,
    shortScore: calculatedShortScore,
    techLong: hasWhaleShort ? Math.round(techScore * 0.7) : techScore,
    techShort: calculatedShortScore,
    fundScore: techScore,
    whaleScore: scoreWhale,
    globalScore: techScore,
    fundBullish: techScore,
    whaleBullish: scoreWhale,
  ...
  if (ASSET_SCORE_CACHE.size >= MAX_ASSET_SCORE_CACHE) {
    ASSET_SCORE_CACHE.clear();
  }
  ASSET_SCORE_CACHE.set(cacheKey, result);

  return result;
};

const SHORT_SCORE_CACHE = new Map<string, any>();
const MAX_SHORT_SCORE_CACHE = 1000;

export const calculateShortReversalScore = (s: any, currentPrices: any) => {
  const safePrices = currentPrices || {};
  const liveChange = Number(safePrices[`${s.symbol}_change`] ?? s.change ?? 0);
  const roundedChange = Math.round(liveChange * 100) / 100;
  const cacheKey = `short_${s.symbol}_${roundedChange}`;

  const cached = SHORT_SCORE_CACHE.get(cacheKey);
  if (cached) return cached;

  const pd = getAdjustedTechnicals(s.symbol, liveChange);
  const realTech = REAL_TECHNICALS_CACHE[s.symbol];

  const rsi = realTech?.rsi ?? pd.rsi;
  const macd = realTech?.macd ?? pd.macd;
  const fib = realTech?.fibLevel ?? pd.fibLevel ?? "0.618";

  // Real EMA bearish states
  const isEmaBearish = realTech ? (realTech.ema7 < realTech.ema21) : (!pd.emaBullish || liveChange < 0);
  const isEmaDeathCross = realTech 
    ? Boolean((realTech as any).emaCrossedDown || (realTech.ema7 < realTech.ema21 && (realTech as any).ema7Prev >= (realTech as any).ema21Prev))
    : (liveChange < -1.5);
  const bearishHours = realTech?.bearishHours ?? (isEmaBearish ? 4 : 0);

  // 10 4-Saatlik (4S) Teknik İndikatör + 1 FIB Seviyesi (BUY'un TAM TERSİ - HER ŞEY SELL İÇİN SİNYAL VERDİĞİNDE)

  // 1. RSI (14) - 4S:
  // Dirençte Aşırı Alım Reddi (RSI >= 65) veya Ayı Kırılımı (35 <= RSI <= 48). Aşırı satım (< 32) dip tepkisi riski olduğundan short'a elenir.
  let scoreRsi = 45;
  let rsiStatus = "Nötr";
  if (rsi >= 68) {
    scoreRsi = 96; // Mükemmel Direnç Reddi / Aşırı Alımdan Dönüş
    rsiStatus = `Dirençte Aşırı Alım Reddi (RSI ${Math.round(rsi)})`;
  } else if (rsi >= 58 && liveChange < 0) {
    scoreRsi = 90; // Tepeden dönüş satış baskısı
    rsiStatus = `Zirveden Satış Baskısı (RSI ${Math.round(rsi)})`;
  } else if (rsi >= 35 && rsi < 48) {
    scoreRsi = 86; // Ayı momentum teyidi
    rsiStatus = `Ayı Momentum Kırılımı (RSI ${Math.round(rsi)})`;
  } else if (rsi < 35) {
    scoreRsi = 35; // Aşırı satım - short tehlikeli, dip tepkisi riski
    rsiStatus = `Aşırı Satım Dibi (Short Riski: RSI ${Math.round(rsi)})`;
  } else {
    scoreRsi = 48;
    rsiStatus = `Dengesiz Bölge (RSI ${Math.round(rsi)})`;
  }

  // 2. MACD (12, 26, 9) - 4S:
  // Negatif MACD güçlü SELL puanı alır, Pozitif MACD cezalandırılır (Buy'un tam tersi)
  let scoreMacd = 35;
  let macdStatus = "Nötr";
  if (macd < -1.0) {
    scoreMacd = 96; // Çok Güçlü Ayı Hükmü
    macdStatus = `Güçlü Ayı Kesişimi (${macd.toFixed(2)})`;
  } else if (macd < -0.3) {
    scoreMacd = 90; // Negatif Kesişim
    macdStatus = `Negatif Trend (${macd.toFixed(2)})`;
  } else if (macd <= 0) {
    scoreMacd = 82; // Sıfırın altı satış bölgesi
    macdStatus = `Sıfır Altı Satış Modu (${macd.toFixed(2)})`;
  } else if (macd <= 0.3) {
    scoreMacd = 45; // Zayıf pozitif
    macdStatus = `Zayıf Pozitif (${macd.toFixed(2)})`;
  } else {
    scoreMacd = 15; // Güçlü Boğa MACD - Kesinlikle short açılamaz!
    macdStatus = `Boğa Kesişimi (${macd.toFixed(2)} - Short Yasak)`;
  }

  // 3. EMA (7/21 Death Cross / Ayı Dizilimi) - 4S:
  let scoreEma = 20;
  let emaStatus = "Nötr";
  if (isEmaDeathCross) {
    scoreEma = 98; // 4S EMA 7/21 Death Cross (Ölüm Kesişimi)
    emaStatus = "🔥 4S EMA 7/21 Death Cross (Ölüm Kesişimi)";
  } else if (isEmaBearish && bearishHours <= 48) {
    scoreEma = 92; // Taze Ayı Trendi (EMA 7 < 21)
    emaStatus = `4S EMA 7 < 21 Taze Ayı Trendi (${bearishHours}S)`;
  } else if (isEmaBearish && bearishHours > 48) {
    scoreEma = 82; // Olgun ayı trendi
    emaStatus = `4S EMA 7 < 21 Olgun Ayı (${bearishHours}S)`;
  } else {
    scoreEma = 15; // EMA 7 > 21 Boğa dizilimi - Short kesinlikle uygunsuz!
    emaStatus = "EMA 7 > 21 Boğa Trendi (Short Elendi)";
  }

  // 4. SMA (50/200 & Direnç Reddi) - 4S:
  let scoreSma = (isEmaBearish && liveChange < 0) ? 92 : (liveChange < 0 ? 82 : 45);
  let smaStatus = (isEmaBearish && liveChange < 0) ? "SMA Altında Direnç Reddi" : "SMA Düzeltme Modu";

  // 5. Bollinger Bantları - 4S:
  let scoreBB = liveChange < -2 ? 96 : (liveChange < 0 ? 88 : 50);
  let bbStatus = liveChange < -1 ? "Üst Banttan Sert Ret & Kırılım" : "Bant İçi Konsolidasyon";

  // 6. Stochastic RSI - 4S:
  let scoreStochRsi = (rsi >= 60 || (rsi < 48 && rsi >= 35)) ? 92 : (rsi < 35 ? 35 : 55);
  let stochStatus = rsi >= 60 ? "Aşırı Alımdan Aşağı Kırılım" : (rsi < 35 ? "Aşırı Satım Dibi" : "Ayı Momentum Kırılımı");

  // 7. ADX (14) & DI- - 4S:
  let scoreAdx = (Math.abs(liveChange) > 1.2 || isEmaBearish) ? 92 : 60;
  let adxStatus = isEmaBearish ? "Güçlü Satış Trendi (DI- Baskın)" : "Zayıf Trend";

  // 8. CCI (20) (Direnç Reddi & Negatif Kanal) - 4S:
  let scoreCci = (macd < 0 || liveChange < -0.6) ? 90 : 50;
  let cciStatus = (macd < 0 || liveChange < -0.6) ? "Negatif Kanalda Seyir" : "Pozitif Bölge";

  // 9. SuperTrend (4S) - SAT (Sell) Modu:
  let scoreSuperTrend = (macd <= 0.05 && isEmaBearish) ? 96 : 25;
  let superTrendStatus = (macd <= 0.05 && isEmaBearish) ? "SuperTrend SAT Modu Aktif" : "SuperTrend AL Modunda (Elendi)";

  // 10. Hacim & OBV Flow - Satış Hacmi Desteği:
  let scoreVolume = liveChange < -2 ? 96 : (liveChange < 0 ? 90 : 55);
  let volumeStatus = liveChange < -1 ? "Yüksek Hacimli Kar Satışı" : "Normal Dağıtım Hacmi";

  // 11. Fibonacci (FIB) Direnç Reddi - 4S:
  let scoreFib = 70;
  let fibStatus = "FIB Nötr";
  if (fib === "0.786" || fib === "0.618") {
    scoreFib = 96; // Direnç bölgesinden dönüş (Rebound from resistance)
    fibStatus = "🎯 Fib %61.8 / %78.6 Direnç Reddi";
  } else if (fib === "0.5") {
    scoreFib = 84;
    fibStatus = "Fib %50 Direnci Aşılamadı";
  } else {
    scoreFib = 60;
    fibStatus = "Fib Alt Seviye";
  }

  // 12. Bybit V5 Top 100 Traders Balina Short Belirlemesi (4S)
  const isCryptoAsset = s.symbol.includes("USDT");
  const topTraderRatio = isCryptoAsset ? getTop100TraderRatio(s.symbol, liveChange) : null;
  let scoreWhaleShort = 65;
  let whaleShortStatus = "Nötr Dağılım";

  if (topTraderRatio) {
    if (topTraderRatio.isOverLong) {
      scoreWhaleShort = 98; // Balinalar aşırı long yığılmasında -> Likidasyon temizliği & Short düşüş fırsatı!
      whaleShortStatus = `⚠️ Top 100 Aşırı Long (%${topTraderRatio.buyRatio} Long Tasfiyesi)`;
    } else if (topTraderRatio.sellRatio >= 48.0 && !topTraderRatio.isShortSqueeze) {
      scoreWhaleShort = 92; // Balina short baskısı
      whaleShortStatus = `🔴 Top 100 Short Dağıtımı (%${topTraderRatio.sellRatio} Short)`;
    } else if (topTraderRatio.isShortSqueeze) {
      scoreWhaleShort = 20; // Squeeze tehlikesi! Fiyat yukarı patlayabilir, short açılması yasak/riskli!
      whaleShortStatus = `⚡ Squeeze Tehlikesi (%${topTraderRatio.sellRatio} Short - Short Elendi)`;
    } else {
      scoreWhaleShort = 55;
      whaleShortStatus = `⚖️ Top 100 Dengeli (%${topTraderRatio.buyRatio}L / %${topTraderRatio.sellRatio}S)`;
    }
  } else {
    scoreWhaleShort = liveChange < -1.5 ? 92 : (liveChange < 0 ? 80 : 45);
    whaleShortStatus = liveChange < -1.5 ? "Kurumsal Çıkış / Dağıtım" : "Nötr Kurumsal Dağılım";
  }

  const indicatorBreakdown = [
    { name: "RSI (14)", score: scoreRsi, weight: "%8.33", status: rsiStatus },
    { name: "MACD (12,26,9)", score: scoreMacd, weight: "%8.33", status: macdStatus },
    { name: "EMA (7/21)", score: scoreEma, weight: "%8.33", status: emaStatus },
    { name: "SMA (50/200)", score: scoreSma, weight: "%8.33", status: smaStatus },
    { name: "Bollinger Bantları", score: scoreBB, weight: "%8.33", status: bbStatus },
    { name: "Stochastic RSI", score: scoreStochRsi, weight: "%8.33", status: stochStatus },
    { name: "ADX & DI-", score: scoreAdx, weight: "%8.33", status: adxStatus },
    { name: "CCI (20)", score: scoreCci, weight: "%8.33", status: cciStatus },
    { name: "SuperTrend (4S)", score: scoreSuperTrend, weight: "%8.33", status: superTrendStatus },
    { name: "Hacim & OBV", score: scoreVolume, weight: "%8.33", status: volumeStatus },
    { name: "Fibonacci Çizelgesi", score: scoreFib, weight: "%8.33", status: fibStatus },
    { name: isCryptoAsset ? "Top 100 Balina L/S" : "Kurumsal Dağıtım", score: scoreWhaleShort, weight: "%8.33", status: whaleShortStatus }
  ];

  const totalSum = indicatorBreakdown.reduce((sum, item) => sum + item.score, 0);
  const shortTechScore = Math.min(99, Math.max(30, Math.round(totalSum / indicatorBreakdown.length)));

  // "herşey sell için sinyal verdiğinde getir. Buy’un tam tersi."
  // Strict condition: EVERY major indicator must be in SELL / BEARISH mode:
  // 1. EMA 7 < EMA 21 (Ayı dizilimi / Death cross)
  // 2. MACD <= 0.05 (Negatif momentum)
  // 3. RSI satışı teyit etmeli (RSI >= 52 direnç reddi VEYA 35-48 arası ayı momentumu, asla < 32 dip değil)
  // 4. SuperTrend SAT modunda olmalı (scoreSuperTrend >= 80)
  // 5. Short skoru >= 75 olmalı
  // 6. Top 100 Balina Squeeze tehlikesi olmamalı (isShortSqueeze = false)
  const isAllSellConfirmed = isEmaBearish && macd <= 0.05 && rsi >= 35 && scoreSuperTrend >= 80 && shortTechScore >= 75 && !(topTraderRatio?.isShortSqueeze);

  const result = {
    score: shortTechScore,
    techScore: shortTechScore,
    shortScore: shortTechScore,
    side: "short" as const,
    isAllSellConfirmed,
    isEmaBearish,
    isEmaDeathCross,
  ...
  if (SHORT_SCORE_CACHE.size >= MAX_SHORT_SCORE_CACHE) {
    SHORT_SCORE_CACHE.clear();
  }
  SHORT_SCORE_CACHE.set(cacheKey, result);
...
const [candidates, setCandidates] = useState<Record<string, any[]>>(() => {
  ...
  return safeJsonParse(saved, { BIST: [], CRYPTO: [], EMTİA: [] });
    ...
    [...BIST_STOCKS, ...CRYPTO_COINS, ...COMMODITY_ITEMS].forEach(s => { 
      if (s && s.symbol && !p[s.symbol]) {
        let basePrice = initialMocks[s.symbol] || s.price || 0;
        p[s.symbol] = basePrice; 
        p[`${s.symbol}_change`] = initialChanges[s.symbol] || (s.change || 0); 
      }
    });

    // Restore cached live prices to prevent flickering on page load
    const savedPrices = safeJsonParse(safeStorage.getItem("app_live_prices"), null);
    if (savedPrices && typeof savedPrices === "object") {
      Object.assign(p, savedPrices);
    }
  ...
  const [lastUpdated, setLastUpdated] = useState<string>(() => safeStorage.getItem("app_last_updated") || "");
...
const [timeframe, setTimeframe] = useState("4S");
...
const previousScreenRef = useRef<string>("scanner");
...
useEffect(() => {
  ...
  const fetchCryptoFallback = useCallback(async () => {
    ...
    try {
      ...
      // 1. Live Bybit Market Tickers (Native CORS, 100% Bybit Perpetual & Spot pairs)
      try {
        const bybitLinearRes = await tryFetch(`https://api.bybit.com/v5/market/tickers?category=linear&_=${cacheBuster}`);
        if (bybitLinearRes?.result?.list && Array.isArray(bybitLinearRes.result.list)) {
          setPrices(prev => {
            const next = { ...prev };
            bybitLinearRes.result.list.forEach((t: any) => {
              if (t.symbol && t.symbol.endsWith("USDT")) {
                ...
                if (!isNaN(price) && price > 0) {
                  next[sym] = price;
                  next[`${sym}_change`] = parseFloat(changePct.toFixed(2));
                  next[`${sym}_source`] = "BYBIT";
                  if (t.symbol === "SHIB1000USDT") {
                    next["SHIB-USDT"] = price / 1000;
                    next["SHIB-USDT_change"] = parseFloat(changePct.toFixed(2));
                    next["SHIB-USDT_source"] = "BYBIT";
                  }
                }
              }
            });
        ...
        console.warn("Bybit linear ticker fetch error:", e);
      }

      try {
        const bybitSpotRes = await tryFetch(`https://api.bybit.com/v5/market/tickers?category=spot&_=${cacheBuster}`);
        if (bybitSpotRes?.result?.list && Array.isArray(bybitSpotRes.result.list)) {
          setPrices(prev => {
            const next = { ...prev };
            bybitSpotRes.result.list.forEach((t: any) => {
              if (t.symbol === "USDTTRY") {
                const tryPrice = parseFloat(t.lastPrice);
                const tryChangePct = parseFloat(t.price24hPcnt) * 100;
                if (!isNaN(tryPrice) && tryPrice > 0) {
                  next["USDT-TRY"] = tryPrice;
                  next["USDT-TRY_change"] = parseFloat(tryChangePct.toFixed(2));
                  next["USDT-TRY_source"] = "BYBIT";
                  next["USDTTRY"] = tryPrice;
                }
              }
              ...
              if (t.symbol && t.symbol.endsWith("USDT")) {
                ...
                const price = parseFloat(t.lastPrice);
                const changePct = parseFloat(t.price24hPcnt) * 100;
                if (!isNaN(price) && price > 0 && !next[sym]) {
                  next[sym] = price;
                  next[`${sym}_change`] = parseFloat(changePct.toFixed(2));
                  next[`${sym}_source`] = "BYBIT";
                }
        ...
        console.warn("Bybit spot ticker fetch error:", e);
      }

      // Ensure all supported coins have values
      setPrices(prev => {
        const next = { ...prev };
      ...
      if (res.ok) {
        ...
        if (count === 0) {
          ...
          setPrices(prev => {
            ...
            for (const [symbol, info] of Object.entries(data)) {
              ...
              if (infoData && typeof infoData === 'object') {
                ...
                if (typeof infoData.price === 'number' && infoData.price > 0) {
                  if (prev[symbol] !== infoData.price) {
                    next[symbol] = infoData.price;
                    hasChanged = true;
                  }
                }
                // Always update other metrics if they exist and changed
                if (typeof infoData.change === 'number' && prev[`${symbol}_change`] !== infoData.change) {
                  next[`${symbol}_change`] = infoData.change;
                  hasChanged = true;
                }
                if (typeof infoData.volume === 'number' && prev[`${symbol}_volume`] !== infoData.volume) {
                  next[`${symbol}_volume`] = infoData.volume;
                  hasChanged = true;
                }
                if (infoData.source && prev[`${symbol}_source`] !== infoData.source) {
                  next[`${symbol}_source`] = infoData.source;
                  hasChanged = true;
                }
                if (infoData.lastUpdated && prev[`${symbol}_lastUpdated`] !== infoData.lastUpdated) {
                  next[`${symbol}_lastUpdated`] = infoData.lastUpdated;
                  hasChanged = true;
                }
              } else if (typeof infoData === 'number') {
                // Handle primitive numeric values (like _change fields)
                if (prev[symbol] !== infoData) {
            ...
            if (hasChanged) {
              safeStorage.setItem("app_live_prices", safeJsonStringify(next));
            }
        ...
        safeStorage.setItem("app_last_updated", updatedTime);
      } else {
  ...
  const handleRefresh = async () => {
    ...
    setTick(t => t + 1);
    try {
      // 1. Fetch current price cache immediately (sub-second!)
      await fetchPrices();
      fetchNews();
      // 2. Trigger fresh background update without blocking UI
  ...
  useEffect(() => {
    // Top major cryptos for background prefetch
    const topCryptos = [
      "BTC-USDT", "ETH-USDT", "SOL-USDT", "BNB-USDT", "XRP-USDT", "DOGE-USDT"
    ];

    let isMounted = true;
    const loadTopCryptoTechnicals = async () => {
      try {
        await Promise.allSettled(topCryptos.map(sym => fetchRealBinanceTechnicals(sym)));
        if (isMounted) {
          setTick(t => t + 1); // Single re-render after top coins are fetched
        }
      } catch (e) {}
    };

    // Run on ~1 minute interval; don't flash reload if data is already cached
    const hasCached = topCryptos.some(sym => REAL_TECHNICALS_CACHE[sym]);
    const initialDelay = setTimeout(() => {
      if (!hasCached) {
        loadTopCryptoTechnicals();
      }
    }, 4000);

    const interval = setInterval(loadTopCryptoTechnicals, 60000);
    return () => {
      isMounted = false;
  ...
  scanIntervalRef.current = setInterval(() => {
    ...
    if (p >= 100) {
      ...
      const found = stocks.flatMap(s => {
        // Use live price if available, otherwise fallback to realistic baseline
        let livePrice = prices[s.symbol] || REAL_CRYPTO_LIVE_PRICES[s.symbol]?.price || REALISTIC_CRYPTO_PRICES[s.symbol] || s.price || 0;
        if (livePrice === 0 && !s.symbol.includes("-USDT")) {
          const seed = getSymbolSeed(s.symbol);
          livePrice = 10 + (seed % 500);
        }
        ...
        const isCrypto = s.symbol.includes("USDT") || s.sector === "Crypto";
        if (isCrypto && !BYBIT_VERIFIED_SYMBOLS.has(s.symbol)) return [];
      ...
      if (finalFound.length === 0 && stocks.length > 0) {
        finalFound = stocks
          .filter(s => !s.symbol.includes("USDT") || BYBIT_VERIFIED_SYMBOLS.has(s.symbol))
          .map(s => {
          const scores = calculateAssetScore(s, prices);
          const seed = getSymbolSeed(s.symbol);
          const isCrypto = s.symbol.includes("USDT");
          const boostedScore = Math.max(82, scores.score);
          return {
            ...s,
            score: boostedScore,
            dynamicPotential: boostedScore,
            finalScore: boostedScore,
            side: 'long',
            maBuyCount: scores.maBuyCount || 9,
            whale: { action: "ALIM", amount: isCrypto ? `${((seed % 30) / 10 + 1).toFixed(1)}M$` : `${(seed % 40 + 15)}M ₺` },
            techScore: boostedScore,
            fundScore: boostedScore,
            whaleScore: boostedScore,
            globalScore: boostedScore,
            pd: scores.pd
          };
        }).sort((a, b) => b.score - a.score).slice(0, 10);
      }

      setCandidates(prev => ({ ...prev, [targetMarket]: finalFound }));
    }
...
const fetchAiAnalysis = useCallback(async (stock: any) => {
  ...
  try {
    ...
    const prompt = `Analist: ${isCrypto ? "Kripto (Bybit)" : "Borsa"}. Varlık: ${stock.symbol}. 
Zaman Dilimi: 4 SAATLİK (4H).
Sistem Sinyali: ${systemDecision}.
${whaleInfo}
Veri: GÜNCEL FİYAT ${promptPrice}, Değişim %${promptChange.toFixed(2)}, 4S RSI ${Math.round(pd.rsi)}, 4S MACD ${pd.macd > 0 ? "Pozitif ("+pd.macd.toFixed(2)+")" : "Negatif ("+pd.macd.toFixed(2)+")"}, Formasyon: ${pd.pattern}.

Talimat: Verilen 4 Saatlik (4H) canlı Bybit verilerine dayanarak profesyonel, net ve disiplinli bir teknik analiz yap. Analiz metninde 4S RSI'ın ${Math.round(pd.rsi)} olduğunu ve bu değere göre yorumladığını net olarak belirt. Model olarak Gemini 3.8 Flash derin piyasa mantığını kullan.
Sistem bu varlık için 4 Saatlik trende göre ${systemDecision} sinyali verdi. Analizini bu yöne, 4S ana yapı ve 1S onayına odaklanarak yap. Özellikle ${whaleInfo} verisini dikkate al.

VURGULANACAK KRİTERLER:
1. HEDEF TP1 seviyesini 1 SAATLİK (1H) teknik yapıya (Direnç/Destek) göre belirle.
2. HEDEF TP2 seviyesini 4 SAATLİK (4H) ana trend hedefi (Ana Direnç/Destek) olarak belirle.
3. STOP LOSS seviyesini 4 SAATLİK (4H) güçlü trend yapısının hemen dışına/altına yerleştir.

ÖNEMLİ: Tüm seviyeleri MUTLAKA ${promptPrice} baz fiyatı üzerinden hesapla ve yüzde değil, net fiyat değeri olarak ver. Analiz sadece sana sağlanan 4S verilere göre olmalıdır.

İÇERİK PLANI:
1. 🎯 FORMASYON: 4 Saatlik fiyatta gözlemlenen ${pd.pattern} formasyonunu yorumla.
2. 📊 TEKNİK: 4S RSI (${Math.round(pd.rsi)}) ve 4S MACD (${pd.macd.toFixed(2)}) verilerini yorumla.
3. 🚀 HEDEFLER: GİRİŞ: ${promptPrice} | TP1: (1S Seviyesi) | TP2: (4S Ana Direnç/Destek).
4. 🛡️ RİSK: STOP LOSS (4S Destek Altı/Direnç Üstü) ve R:R dengesi.
5. 💎 KARAR: 4S ana trend doğrultusunda ${systemDecision} stratejisinin başarı olasılığı ve sinyalin güçlü yönleri.`;

    const res = await fetch("/api/ai/analyze", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ prompt, symbol: stock.symbol })
    });
    ...
    const data = await res.json();
    const text = data.text || "Analiz yüklenemedi.";
    setAiAnalysis(text);
    setAiCache(prev => ({ ...prev, [cacheKey]: text }));
  } catch (err: any) {
    console.warn("AI Analysis Info, using algorithmic fallback:", err);
    const isShortTrade = systemDecision.includes("SELL") || systemDecision.includes("SHORT");
    const numPrice = promptPrice || 100;
    const precision = getPrecision(stock.symbol, isCrypto);
    const tp1Val = isShortTrade ? (numPrice * 0.982).toFixed(precision) : (numPrice * 1.018).toFixed(precision);
    const tp2Val = isShortTrade ? (numPrice * 0.965).toFixed(precision) : (numPrice * 1.038).toFixed(precision);
    const slVal = isShortTrade ? (numPrice * 1.014).toFixed(precision) : (numPrice * 0.986).toFixed(precision);

    const fallbackReport = `🎯 1. FORMASYON & YAPI ANALİZİ:
${stock.symbol} grafiğinde 4 Saatlik (4H) ana trend ve 1 Saatlik (1H) teyit zaman dilimlerinde "${pd.pattern}" formasyonu gözlemlenmiştir. 4S fiyat yapısı ${isShortTrade ? "direnç reddi ve kar satışı baskısı" : "destek reaksiyonu ve trend teyidi"} sergilemektedir.

📊 2. TEKNİK GÖSTERGE YORUMU:
• 4S RSI (${Math.round(pd.rsi)}): ${pd.rsi < 35 ? "4S aşırı satım dip bölgesinden hacimli alıcı tepkisi." : pd.rsi > 65 ? "4S aşırı alım tepe direncinde momentum zayıflaması." : "4S dengeli momentum bölgesi."}
• 4S MACD (${pd.macd.toFixed(2)}): ${pd.macd > 0 ? "Pozitif bölgede, 4S boğa trendinin devam ettiğini onaylıyor." : "Negatif bölgede, satıcı baskısının devam ettiğini teyit ediyor."}
• 4H / 1H Yapı: 4S EMA 7 ve EMA 21 ortalamaları yönlü sinyal uyumu sergilemektedir.

🚀 3. HEDEFLER:
• GİRİŞ SEVİYESİ: ${promptPrice}
• 1. HEDEF (TP1 - 1S Yapı Seviyesi): ${tp1Val}
• 2. HEDEF (TP2 - 4S Ana Direnç/Destek): ${tp2Val}

🛡️ 4. RİSK YÖNETİMİ & STOP LOSS:
• STOP LOSS (4S Yapı Altı/Üstü): ${slVal}
• Risk / Kazanç (R:R): 1 : 2.4

💎 5. KARAR & STRATEJİ:
4 Saatlik (4H) trend doğrultusunda ${systemDecision} stratejisi, Bybit hacim teyidi ve çoklu zaman dilimi korelasyonu ile yüksek olasılıklı işlem fırsatı sunmaktadır. Belirlenen 4S Stop Loss seviyesine sadık kalınarak kademeli kar alma tavsiye edilir.`;

    setAiAnalysis(fallbackReport);
    setAiCache(prev => ({ ...prev, [cacheKey]: fallbackReport }));
  }
  setAiLoading(false);
}, [prices, aiCache]);
...
const generateSmartPortfolio = useCallback(async (targetMarket?: string, isBackground: boolean = false) => {
  if (portfolioLoading) return;
  const activeMarket = targetMarket || market;
  console.log(`[App] generateSmartPortfolio starting for ${activeMarket} (isBackground: ${isBackground})`);
  if (!isBackground) {
  ...
  try {
    ...
    // 3. Score and select candidates (High confidence candidates with fallback)
    let scoredCandidates: any[] = [];
    
    scoredCandidates = marketStocks.map(s => {
      try {
        const scores = calculateAssetScore(s, prices);
        if (!scores.isEligible || scores.score < 80) return null;
    ...
    // If market conditions yield few 80+ candidates, take top scoring assets
    if (scoredCandidates.length < 4) {
      scoredCandidates = marketStocks
        .filter(s => {
          if (s.symbol.includes("USDT")) {
            const liveChange = Number(prices[`${s.symbol}_change`] ?? s.change ?? 0);
            const topRatio = getTop100TraderRatio(s.symbol, liveChange);
            if (topRatio && (topRatio.isWhaleShort || topRatio.sellRatio >= 50.0)) return false;
          }
          return true;
        })
        .map(s => {
    ...
    // Select top candidates sorted by score
    let selectedNew = availableCandidates
      .sort((a: any, b: any) => b.score - a.score);
      
    // If we have more than 8 total slots, cap it
    const maxNewSlots = Math.max(4, 8 - stayingItems.length);
    
    if (selectedNew.length > maxNewSlots) {
      selectedNew = selectedNew.slice(0, maxNewSlots);
    }
    
    // Absolute fallback: If still less than 4, take top available
    if (selectedNew.length + stayingItems.length < 4 && marketStocks.length > 0) {
       ...
       const emergencyItems = marketStocks
         .filter(s => {
           if (currentSymbols.includes(s.symbol)) return false;
           if (s.symbol.includes("USDT")) {
             const liveChange = Number(prices[`${s.symbol}_change`] ?? s.change ?? 0);
             const topRatio = getTop100TraderRatio(s.symbol, liveChange);
             if (topRatio && (topRatio.isWhaleShort || topRatio.sellRatio >= 50.0)) return false;
    ...
    // Keep assets aligned with their true technical direction (long for bullish 96+ scores)
    // Do NOT force flip a top bullish (Güçlü Al) asset into a short order
    const hasShort = selectedNew.some((c: any) => c.side === 'short');
    if (hasShort) {
      console.log("[App] Natural short asset present in selection");
    }
...
useEffect(() => {
  const checkAll = async () => {
    ...
    try {
      // 1. Refresh Live Data & Bybit Top 100 Traders Whale Radar (Parallelized for speed)
      await Promise.allSettled([
        fetchPrices(),
        fetchNews(),
        fetchBybitBatch(false, "4h").then(items => {
          if (Array.isArray(items)) {
            items.forEach(item => {
              BYBIT_TOP100_RATIOS[item.symbol] = {
                buyRatio: item.buyRatio,
                sellRatio: item.sellRatio,
                determination: item.determination,
                determinationLabel: item.determinationLabel,
                determinationDesc: item.determinationDesc,
                isShortSqueeze: item.isShortSqueeze,
                isOverLong: item.isOverLong,
                isStrongWhaleLong: item.isStrongWhaleLong,
                isWhaleShort: item.isWhaleShort
              };
              const clean = item.cleanSymbol;
              if (clean) {
                BYBIT_TOP100_RATIOS[clean] = BYBIT_TOP100_RATIOS[item.symbol];
                BYBIT_TOP100_RATIOS[`${clean}-USDT`] = BYBIT_TOP100_RATIOS[item.symbol];
              }
            });
          }
        }).catch(() => {})
      ...
      markets.forEach(m => {
        ...
        if (shouldUpdate && !portfolioLoadingRef.current) {
          ...
          generateSmartPortfolioRef.current(m, true);
        }
      });
    } catch (e: any) {
  ...
  // Initial load - only set loading if we have absolutely no critical data or cache
  if (Object.keys(prices).length < 2 && !safeStorage.getItem("portfolios") && !safeStorage.getItem("app_live_prices")) {
    setLoading(true);
  }
  
  // Do not flash-refresh every time the user opens the page; space out initial check
  const lastFetchTs = Number(safeStorage.getItem("app_last_fetch_ts") || 0);
  const timeSinceLastFetch = Date.now() - lastFetchTs;
  // If fetched less than 60s ago, wait the remaining time (up to 60s); otherwise wait 3s for smooth paint
  const initialDelayMs = timeSinceLastFetch < 60000 ? Math.max(5000, 60000 - timeSinceLastFetch) : 3000;

  const initialTimer = setTimeout(() => {
    checkAll();
    safeStorage.setItem("app_last_fetch_ts", Date.now().toString());
  }, initialDelayMs);

  // Run average 1 minute (60,000 ms) as requested by user
  const interval = setInterval(() => {
    checkAll();
    safeStorage.setItem("app_last_fetch_ts", Date.now().toString());
  }, 60000);
...
// Background candidate refresher (focused only on active market to eliminate main thread lag)
useEffect(() => {
  if (!scanned[market]) return;
  ...
  const found = marketStocks.flatMap(s => {
    ...
    if (scores.longScore >= 80 && seedOffset > 2) {
      whale = { action: "ALIM", amount: isCrypto ? `${(1.2 + (seed % 40) / 10).toFixed(1)}M$` : `${(15 + (seed % 60))}M ₺` };
    } else if (scores.shortScore >= 80 && seedOffset > 2) {
      whale = { action: "SATIM", amount: isCrypto ? `${(1.2 + (seed % 40) / 10).toFixed(1)}M$` : `${(15 + (seed % 60))}M ₺` };
    }
  ...
  }).sort((a, b) => b.dynamicPotential - a.dynamicPotential).slice(0, 30);

  setCandidates(prev => {
    const prevList = prev[market] || [];
    if (
      prevList.length === found.length &&
      prevList.every((p: any, idx: number) => p.symbol === found[idx]?.symbol && p.dynamicPotential === found[idx]?.dynamicPotential)
    ) {
      return prev;
    }
    return { ...prev, [market]: found };
  });
}, [prices, scanned, market]);

const openDetail = useCallback(async (stock: any) => {
  setScreen(current => {
    if (current !== "detail") previousScreenRef.current = current;
    return "detail";
  });
...
<div style={{ display: "flex", alignItems: "center", gap: 10 }}>
  ...
  <span style={{ color: "#30d158", fontSize: 9, fontWeight: 700, background: "rgba(48,209,88,0.1)", border: "1px solid rgba(48,209,88,0.25)", padding: "1px 6px", borderRadius: 10 }}>
    1 dk
  </span>
</div>
...
<div style={{ background: "#30d158", borderRadius: 2, width: "85%", height: 8 }}/>
    ...
    <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", scrollbarWidth: "none" }}>
      ...
      {screen === "detail" && selectedStock && <DetailScreen
        ...
        onBack={() => setScreen(previousScreenRef.current || "scanner")}
      />}
    </div>
        ...
        {viewMode === "monthly" ? (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
              <div>
                <div style={{ color: "#ff9500", fontSize: 12, fontWeight: 700, letterSpacing: 1, marginBottom: 4 }}>1 AYLIK MODEL PORTFÖY</div>
...
function AssetMoneyFlow({ market, stocks, prices, tick, onSelect }: { market: string, stocks: any[], prices: Record<string, number>, tick: number, onSelect: (s: any) => void }) {
  ...
  if (!isBist) return null; // Kripto Varlık Para Giriş / Çıkış kaldırıldı
  
  const flowData = useMemo(() => {
    if (isBist) {
      const activeSymbols = new Set(["RYSAS", "LINK", "OZATD", "TARKM", "HRKET", "THYAO", "GARAN", "AKBNK", "EREGL", "KCHOL", "SAHOL", "BIMAS", "TUPRS", "SISE", "PETKM", "FROTO", "YKBNK", "ISCTR"]);
      const relevantStocks = stocks.filter(s => activeSymbols.has(s.symbol));
...
function MarketMoneyFlow({ market, tick }: { market: string, tick: number }) {
  const isBist = market === "BIST";
  if (!isBist) return null; // Kripto Spot Para Akışı kaldırıldı
  ...
  const getInitialBuyers = useCallback(() => isBist ? [
    ...
    { name: "Bybit", amount: getSeededAmount(2450, "Bybit") },
    ...
    { name: "Deribit", amount: getSeededAmount(520, "Deribit") },
...
function ScannerScreen({ scanning, scanProgress, scanned, setScanned, candidates = [], setCandidates, prices = {}, lastUpdated, onScan, onViewCandidates, onViewScalp, onViewCorrection, onViewSearch, onViewWhale, onOpenEmailModal, onSelect, portfolio, portfolioLoading, onRefresh, loading, fetchError, stocks = [], market, setMarket, tick, sectionRefresh, setSectionRefresh, monthlyPicks = [] }: any) {
  ...
  const [cryptoSpotExpanded, setCryptoSpotExpanded] = useState(false);

  const top20CryptoSpotTrends = useMemo(() => {
    const TOP_60_VOLUME_SYMBOLS = [
      "BTC-USDT", "ETH-USDT", "SOL-USDT", "BNB-USDT", "XRP-USDT",
      "DOGE-USDT", "ADA-USDT", "SUI-USDT", "AVAX-USDT", "LINK-USDT",
      "DOT-USDT", "NEAR-USDT", "1000PEPE-USDT", "FET-USDT", "RENDER-USDT",
      "SHIB-USDT", "AAVE-USDT", "UNI-USDT", "ARB-USDT", "OP-USDT",
      "APT-USDT", "INJ-USDT", "TIA-USDT", "BEAM-USDT", "LTC-USDT",
      "BCH-USDT", "POL-USDT", "STX-USDT", "FIL-USDT", "ATOM-USDT",
      "ICP-USDT", "ETC-USDT", "SEI-USDT", "WIF-USDT", "1000FLOKI-USDT",
      "1000BONK-USDT", "ORDI-USDT", "ONDO-USDT", "TAO-USDT", "GRT-USDT",
      "ENA-USDT", "W-USDT", "GALA-USDT", "VET-USDT", "WLD-USDT",
      "ALGO-USDT", "EGLD-USDT", "FLOW-USDT", "QNT-USDT", "AXS-USDT",
      "SAND-USDT", "MANA-USDT", "THETA-USDT", "CHZ-USDT", "HYPE-USDT",
      "NEO-USDT", "IMX-USDT", "KAS-USDT", "HBAR-USDT", "RUNE-USDT"
    ];

    const daySeed = Math.floor(Date.now() / 86400000);

    return TOP_60_VOLUME_SYMBOLS.filter(sym => BYBIT_VERIFIED_SYMBOLS.has(sym)).map(sym => {
      ...
      // 1S Fibonacci and Moving Average (EMA 7 / EMA 21) Structural Levels
      const isRealData = Boolean(realTech?.isRealData);
      const fib618 = realTech?.fib618 ?? (livePrice * 0.982);
      const fib50 = realTech?.fib50 ?? (livePrice * 0.988);
      const ema7 = realTech?.ema7 ?? +(livePrice * (1 + (liveChange > 0 ? 0.003 : -0.004))).toFixed(livePrice < 1 ? 4 : 2);
      const ema21 = realTech?.ema21 ?? +(livePrice * (1 - (liveChange > 0 ? 0.006 : 0.004))).toFixed(livePrice < 1 ? 4 : 2);
      const ema50 = realTech?.ema50 ?? +(livePrice * 0.985).toFixed(livePrice < 1 ? 4 : 2);
      const isEmaCrossedUp = realTech?.emaCrossedUp ?? false; // Never claim unverified Golden Cross
      const isEmaBullish = realTech?.emaBullish ?? (ema7 > ema21);
      const bullishHours = realTech?.bullishHours ?? (isEmaBullish ? 4 : 0);
      const isFreshBullish = realTech?.isFreshBullish ?? (isEmaBullish && bullishHours <= 16);
      const bullish15mCount = (realTech as any)?.bullish15mCount ?? 2;
      const is15mConfirmed = (realTech as any)?.is15mConfirmed ?? realTech?.is1HConfirmedMin2H ?? (isEmaBullish && liveChange > 1.0);
      const isAboveFib618 = realTech?.isAboveFib618 ?? (livePrice >= fib618);
      ...
      let trendLabel = "⚠️ 1S KANAL KONSOLİDASYONU";
      if (isEmaCrossedUp && is15mConfirmed) {
        trendLabel = isAboveFib618 
          ? "⚡ 1S GOLDEN CROSS + FIB %61.8 ONAYLI (15D+)"
          : "⚡ 1S EMA 7/21 GOLDEN CROSS (15D ONAYLI)";
      } else if (isEmaCrossedUp && !is15mConfirmed) {
        trendLabel = "⚠️ 1S EMA GOLDEN CROSS (15D ONAY BEKLENİYOR)";
      } else if (isFreshBullish && is15mConfirmed) {
        trendLabel = isAboveFib618 
          ? `🔥 1S EMA 7 > 21 + FIB %61.8 (${bullishHours}S | 15D+)`
          : `🔥 1S EMA 7 > 21 BOĞA TRENDİ (${bullishHours}S | 15D+)`;
      } else if (isFreshBullish && !is15mConfirmed) {
        trendLabel = `⚠️ 1S BOĞA TRENDİ (15D ONAY BEKLENİYOR)`;
      } else if (isEmaBullish && bullishHours > 16) {
        trendLabel = `⚠️ 1S MATÜR TREND (${bullishHours}S > 16S)`;
      }

      let justification = "";
      const fibText = isAboveFib618 
        ? ` Fiyat Fib %61.8 seviyesi (${fib618.toFixed(fib618 < 1 ? 4 : 2)} USDT) üzerine atarak kırılımı teyit etti.` 
        : ` Fib %61.8 seviyesi (${fib618.toFixed(fib618 < 1 ? 4 : 2)} USDT) takip edilmektedir.`;

      if (isNewTrend && is15mConfirmed) {
        justification = `⚡ ${name} (${sym.replace("-USDT","")}), 1S periyotta EMA 7 (${ema7.toFixed(ema7 < 1 ? 4 : 2)}) / EMA 21 (${ema21.toFixed(ema21 < 1 ? 4 : 2)}) Golden Cross sağladı ve 15D grafikte teyitli.${fibText} %${((volIncrease - 1) * 100).toFixed(0)} hacim desteğiyle %${score} teknik güç skoruna ulaştı.`;
      } else if (isNewTrend && !is15mConfirmed) {
        justification = `⚠️ ${name} (${sym.replace("-USDT","")}), 1S periyotta EMA 7 / EMA 21 Golden Cross oluşumu var ancak alt periyotta onay süreci bekleniyor (%${score} Güç Skoru).`;
      } else if (isFreshBullish && is15mConfirmed) {
        justification = `🔥 ${name} (${sym.replace("-USDT","")}), 1S taze boğa trendinde (${bullishHours}S, maks 16S) ve 15D EMA 7 > 21 kesişimi onaylanmış durumda.${fibText} %${score} Güç Skoru veriyor.`;
      } else if (isFreshBullish && !is15mConfirmed) {
        justification = `⚠️ ${name} (${sym.replace("-USDT","")}), 1S EMA 7 > 21 boğa trendinde ancak ikincil onay bekleniyor (%${score} Güç Skoru).`;
      } else {
        justification = `⚠️ ${name} (${sym.replace("-USDT","")}), 1S EMA 7 > 21 trendi ${bullishHours} saattir devam ettiği için trend matürleşmiştir. Doygunluk direnç seviyelerinde kâr satışı ve konsolidasyon takibi önerilir (%${score} Güç Skoru).`;
      }
  ...
  const safeStocks = useMemo(() => {
    ...
    if (market === "CRYPTO") {
      return stocks.filter(s => BYBIT_VERIFIED_SYMBOLS.has(s.symbol));
    }
    return stocks;
  }, [stocks, market]);
  ...
  const hunterPicks = useMemo(() => {
    ...
    // Focus on top liquid stocks to keep main thread fast & responsive
    const candidatePool = safeStocks.slice(0, 45);
    return candidatePool.map(s => {
      ...
      let justification = `${s.symbol} varlığında 4S periyotta RSI (${Math.round(scores.pd.rsi)}), MACD ve hacim verileri %100 teknik analiz uyumuyla %${score} Güç Skoru üretiyor.`;
      if (market === "CRYPTO" && scores.topTraderRatio) {
        justification += ` Bybit Top 100 Traders L/S oranı: %${scores.topTraderRatio.buyRatio}L / %${scores.topTraderRatio.sellRatio}S (${scores.topTraderRatio.determinationLabel}).`;
      }
  ...
  const reboundCandidates = useMemo(() => {
    ...
    // Collect all symbols that are evaluated as LONG / BULLISH in upper cards
    const topLongSymbols = new Set<string>();
    top20CryptoSpotTrends.forEach(t => {
      if (t.isFreshBullish || t.isEmaCrossedUp || t.score >= 75) {
        topLongSymbols.add(t.symbol);
      }
    });
    (Array.isArray(candidates) ? candidates : []).forEach((c: any) => {
      if ((c.score || c.dynamicPotential || 0) >= 75) {
        topLongSymbols.add(c.symbol);
      }
    });
    hunterPicks.forEach((h: any) => topLongSymbols.add(h.symbol));

    const candidatePool = safeStocks;
    const evaluated = candidatePool
      .filter(s => !topLongSymbols.has(s.symbol)) // Strictly exclude any symbol that is LONG at the top!
      .map(s => {
        const shortEval = calculateShortReversalScore(s, prices);
        const liveChange = Number(prices[`${s.symbol}_change`] ?? s.change ?? 0);
        const seed = getSymbolSeed(s.symbol);
        const volSpike = 1.6 + ((seed * 0.4) % 1.5) + (Math.abs(liveChange) > 1.2 ? 0.7 : 0);

        let signalType = "DİRENÇ REDDİ (SHORT)";
        let justification = "";
        if (shortEval.isEmaDeathCross) {
          signalType = "4S DEATH CROSS (ÖLÜM KESİŞİMİ)";
          justification = `${s.symbol} 4S periyotta EMA 7 / EMA 21 Death Cross gerçekleştirdi. MACD (${shortEval.pd.macd.toFixed(2)}) negatif bölgede, RSI (${Math.round(shortEval.pd.rsi)}) direnç reddi ve ${volSpike.toFixed(1)}x satış hacim teyidiyle %100 SELL teyidi veriyor.`;
        } else if (shortEval.pd.rsi >= 60) {
          signalType = "DİRENÇTE AŞIRI ALIM REDDİ";
          justification = `${s.symbol} 4S periyotta tepe direnç bölgesinden (RSI ${Math.round(shortEval.pd.rsi)}) sert ret yiyerek kar satışı baskısı başlattı. EMA 7 < 21 ayı dizilimi ve ${volSpike.toFixed(1)}x satış hacmi desteğiyle DİRENÇ DÖNÜŞÜ (SHORT) sinyali veriyor.`;
        } else {
          signalType = "4S EMA 7 < 21 AYI BASKISI";
          justification = `${s.symbol} 4S grafikte EMA 7 < 21 ayı trendinde direnç baskısı altında. MACD negatif, SuperTrend SAT konumunda ve tüm 12 teknik gösterge SELL yönlü teyit üretiyor (Satış Güç Skoru: %${shortEval.score}).`;
        }

        if (market === "CRYPTO") {
          const topTraderRatio = getTop100TraderRatio(s.symbol, liveChange);
          if (topTraderRatio) {
            justification += ` Bybit Top 100 Traders: %${topTraderRatio.buyRatio}L / %${topTraderRatio.sellRatio}S (${topTraderRatio.determinationLabel}).`;
          }
        }

        return {
          ...s,
          rsi: shortEval.pd.rsi,
          macd: shortEval.pd.macd,
          volSpike,
          score: shortEval.score,
          side: "short" as const,
          signalType,
          source: 'REBOUND',
          isRebound: shortEval.isAllSellConfirmed,
          isAllSellConfirmed: shortEval.isAllSellConfirmed,
          isEmaBearish: shortEval.isEmaBearish,
          isEmaDeathCross: shortEval.isEmaDeathCross,
          pd: shortEval.pd,
          indicatorBreakdown: shortEval.indicatorBreakdown,
          justification
        };
      });

    // "herşey sell için sinyal verdiğinde getir. Buy’un tam tersi."
    // Strictly filter for confirmed sell setups (isAllSellConfirmed):
    // EMA 7 < 21, MACD <= 0.05, RSI resistance rejection/breakdown, SuperTrend SAT, and short score >= 75
    const confirmedSellList = evaluated
      .filter(s => s.isAllSellConfirmed && s.score >= 75)
      .sort((a, b) => b.score - a.score);

    if (confirmedSellList.length > 0) {
      return confirmedSellList.slice(0, 3);
    }

    // Fallback: If market is overwhelmingly bullish, strictly require EMA 7 < 21 AND MACD <= 0.05
    const fallbackBearish = evaluated
      .filter(s => s.isEmaBearish && s.macd <= 0.05 && s.score >= 70)
      .sort((a, b) => b.score - a.score);

    return fallbackBearish.slice(0, 3);
  }, [safeStocks, market, prices, top20CryptoSpotTrends, candidates, hunterPicks]);

  const topMovers = useMemo(() => {
    const isBist = market === "BIST";
    // Sort top candidate pool by volume
    const candidatePool = safeStocks.slice(0, 50);
    const volRanked = candidatePool.map(s => {
      const seed = getSymbolSeed(s.symbol);
  ...
  const safeCandidates = useMemo(() => {
    return (Array.isArray(candidates) ? candidates : []).filter((c: any) => (c.score || c.dynamicPotential || 0) >= 80);
  }, [candidates]);
  ...
  const smartPicks = useMemo(() => {
    ...
    const all = [
      ...safeCandidates.map(c => ({ ...c, source: 'ADAY', side: c.side || 'long', weight: (c.dynamicPotential || 0) })),
      ...hunterPicks.map(c => ({ ...c, source: 'ALPHA', side: 'long', weight: (c.alphaScore || 0) })),
      ...reboundCandidates.map(c => ({ ...c, source: 'REBOUND', side: c.side || 'short', weight: (c.score || 0) + 15 })), // Strong structural preference
      ...topMovers.map(c => ({ 
        ...c, 
        source: 'FLOW', 
        side: 'long',
    ...
    const unique = all.reduce((acc: any[], curr) => {
      ...
      if (!exists) acc.push(curr);
          ...
          exists.side = curr.side;
          exists.justification = curr.justification;
      }
      return acc;
    }, []);
    ...
    return sorted.map(s => {
        ...
        const isShort = s.side === 'short' || s.source === 'REBOUND';
        ...
        const longReasons = [
          ...
          `4S grafikte EMA 7, EMA 21'i yukarı keserek güçlü momentum sağladı. Fibonacci %38.2 desteği üzerinde 4S hacimli kanal kırılımı teyit edildi. Hacim ivmesi: %${volRatio.toFixed(0)}.`,
        ...
        const shortReasons = [
          `4S periyotta direnç bölgesinden (RSI ${Math.round(rsiVal)}) hacim desteğiyle kar satışı baskısı ve DİRENÇ DÖNÜŞÜ (SHORT) sinyali veriyor. Ayı uyumsuzluğu ve EMA 7 aşağı kesişimi düşüşü tetikliyor.`,
          `4S grafikte tepe direnç seviyesinde bariz ikili tepe (Double Top) ve ayı uyumsuzluğu (Bearish Divergence) oluştu. Fiyat 4S direnç bandından baskı görerek Fibonacci %38.2 ve %50 geri çekilme desteğini hedefliyor.`,
          `4S periyotta direnç re-testi sonrasında yüksek hacimli kar satışı baskısı oluştu. RSI ${Math.round(rsiVal)} seviyesinden aşağı dönerken osilatörler tepe dönüşü ve SHORT teyidi üretiyor.`,
          `4S grafikte tepe bandından sert ret yiyen fiyat, kar realizasyonu dalgası başlattı. Düşüş yönlü hacim artışı (%${volRatio.toFixed(0)}) ile direnç dönüşü sinyali onaylandı.`
        ];
        
        let detail = "";
        if (isShort) {
          reason = shortReasons[getSymbolSeed(s.symbol) % shortReasons.length];
          const dropText = !isCrypto 
            ? " 1-2 gün içerisinde %5-%10 arası kar realizasyonu ve düzeltme geri çekilmesi potansiyeli yüksek." 
            : " 1-2 gün içerisinde %12-%18 arası sert bir kar satışı ve düzeltme geri çekilmesi potansiyeli yüksek.";
          detail = `Derin Teknik Analiz Onayı (Direnç Ret, RSI Tepe & Hacimli Kar Satışı): ${reason} Mevcut indikatör seti 'GÜÇLÜ SAT / DİRENÇ DÖNÜŞÜ (SHORT)' bölgesinde birleşiyor. Tepe direnç sıkışması ve kar realizasyonu baskısı nedeniyle${dropText}`;
        } else {
          reason = longReasons[getSymbolSeed(s.symbol) % longReasons.length];
          const tavanText = !isCrypto 
            ? " 1-2 gün içerisinde TAVAN yapma potansiyeli (patlamaya hazır) çok yüksek." 
            : " 1-2 gün içerisinde %15-%20 arası sert bir yükseliş (patlamaya hazır) potansiyeli çok yüksek.";
          detail = `Derin Teknik Analiz Onayı (MACD, EMA, Fibo): ${reason} Mevcut indikatör setinin tamamı 'GÜÇLÜ AL (LONG)' bölgesinde birleşiyor. Formasyon sıkışması ve anlık para girişi nedeniyle${tavanText}`;
        }
        ...
        const topTraderRatio = isCrypto ? getTop100TraderRatio(s.symbol, liveChange) : null;
        if (isCrypto && topTraderRatio) {
          detail += ` Bybit Top 100 Traders (En İyi 100 Yatırımcı) Long/Short oranı %${topTraderRatio.buyRatio}L / %${topTraderRatio.sellRatio}S ile ${topTraderRatio.determinationLabel} modunda teyit edildi (${topTraderRatio.determinationDesc}).`;
        }
        ...
        const entryRangeMax = isShort ? resistance4h * 1.008 : support4h * 1.008;

        const currencySymbol = isCrypto ? "USDT" : "₺";
        const entryAdvice = isShort
          ? `⚠️ Anlık fiyattan (${livePrice.toFixed(2)} ${currencySymbol}) açığa satış riskli olabilir. Güvenli SHORT giriş bölgesi olan [${entryRangeMin.toFixed(2)} - ${entryRangeMax.toFixed(2)}] 4S tepe direnç bandına re-test beklenmelidir.`
          : `⚠️ Anlık fiyattan (${livePrice.toFixed(2)} ${currencySymbol}) alım yapmak uygun değildir. Güvenli LONG giriş bölgesi olan [${entryRangeMin.toFixed(2)} - ${entryRangeMax.toFixed(2)}] 4S destek kırılım onayı beklenmelidir.`;
...
<div style={{ display: "flex", gap: 6, justifyContent: "flex-end", marginBottom: 6 }}>
  <button 
    onClick={() => onOpenEmailModal && onOpenEmailModal()}
    style={{ 
...
<div style={{ color: "#4a5568", fontSize: 11, marginTop: 4 }}>{stocks.length} {market === "BIST" ? "hisse" : market === "CRYPTO" ? "coin (Bybit Doğrulanmış)" : "varlık"}</div>
{fetchError && <div style={{ color: "#ff453a", fontSize: 9, fontWeight: 700, marginTop: 4 }}>{fetchError}</div>}
    ...
    <div style={{ display: "flex", background: "#21262d", borderRadius: 12, padding: 3, marginTop: 14 }}>
      {[["BIST", "🇹🇷 BİST"], ["CRYPTO", "₿ KRİPTO (BYBIT)"], ["EMTİA", "⚒️ EMTİA"]].map(([key, label]) => (
    ...
    {market === "CRYPTO" && (
      <div style={{ 
        marginTop: 12, 
        background: "linear-gradient(135deg, rgba(191,90,242,0.1) 0%, rgba(0,212,170,0.1) 100%)", 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{ fontSize: 18 }}>🔔</div>
          <div>
            <div style={{ color: "#fff", fontSize: 11, fontWeight: 800 }}>E-POSTA SİNYAL ALARMLARI AKTİF</div>
            <div style={{ color: "#bf5af2", fontSize: 10, fontWeight: 600 }}>Taze Golden Cross & Yeni Coin Sinyalleri Mail Adresinize Gönderilir</div>
          </div>
        </div>
        <button 
          onClick={() => onOpenEmailModal && onOpenEmailModal()}
          style={{ 
            background: "linear-gradient(135deg, #bf5af2, #00d4aa)", 
            color: "#fff", 
            border: "none", 
            padding: "5px 10px", 
            borderRadius: 8, 
    ...
    <div style={{ padding: "20px 20px 16px" }}>
      ...
      {market === "CRYPTO" && (
        <BybitWhaleRadarWidget onSelect={onSelect} onViewFull={onViewWhale} prices={prices} />
      )}
      ...
      {market === "CRYPTO" && (
        <div style={{ marginBottom: 28, background: "linear-gradient(135deg, rgba(0,212,170,0.12), rgba(0,184,255,0.12))", borderRadius: 20, padding: 18, border: "1px solid rgba(0,212,170,0.25)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            ...
            <button
              onClick={() => setCryptoSpotExpanded(!cryptoSpotExpanded)}
              style={{
            ...
            >
              {cryptoSpotExpanded ? "▲ Kapat" : "🔍 İncele (20 Coin)"}
            </button>
          </div>
          ...
          {/* Cards Grid - Limit to 2 unless expanded */}
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {(cryptoSpotExpanded ? filteredCryptoSpotTrends : filteredCryptoSpotTrends.slice(0, 2)).map((coin, i) => (
              <div 
                key={i} 
            ...
            {!cryptoSpotExpanded && filteredCryptoSpotTrends.length > 2 && (
              <button
                onClick={() => setCryptoSpotExpanded(true)}
                style={{
                  width: "100%",
                  marginTop: 4,
                  padding: "12px",
              ...
              >
                🔍 Diğer {filteredCryptoSpotTrends.length - 2} Coini İncele (Toplam {filteredCryptoSpotTrends.length} Coin) →
              </button>
            )}
          </div>
        </div>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            <div style={{ color: "#fff", fontSize: 13, fontWeight: 900, letterSpacing: 0.5, display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ background: "linear-gradient(135deg, #ff453a, #ff9f0a)", width: 4, height: 16, borderRadius: 2 }}></div>
              DÖNÜŞ SİNYALLERİ (DİRENÇ & SHORT HACİM DESTEKLİ)
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <RefreshCw 
                size={12} 
              ...
              />
              <div style={{ background: "rgba(255,69,58,0.1)", color: "#ff453a", fontSize: 9, fontWeight: 800, padding: "3px 10px", borderRadius: 20, border: "1px solid rgba(255,69,58,0.3)", display: "flex", alignItems: "center", gap: 4 }}>
                <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#ff453a", display: "inline-block" }}></span>
                %100 SELL ONAYLI (SHORT)
              </div>
            </div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10, opacity: isAiLoading ? 0.5 : 1, transition: "opacity 0.3s" }}>
            {reboundCandidates.map((pick: any, i: number) => {
              const livePrice = Number(prices[pick.symbol] ?? pick.price ?? 0);
              const liveChange = Number(prices[`${pick.symbol}_change`] ?? pick.change ?? 0);
              const color = "#ff453a";
              const bgFade = "rgba(255,69,58,0.03)";
              const bgSemi = "rgba(255,69,58,0.1)";
              const borderCol = "rgba(255,69,58,0.18)";
              const borderDark = "rgba(255,69,58,0.25)";
              ...
              >
                <div style={{ position: "absolute", top: 0, right: 0, padding: "4px 10px", background: bgSemi, color: color, fontSize: 9, fontWeight: 800, borderBottomLeftRadius: 10, borderLeft: `1px solid ${borderCol}`, borderBottom: `1px solid ${borderCol}` }}>
                  %{pick.score.toFixed(0)} SELL GÜÇ SKORU (SHORT)
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      {livePrice > 0 && (
                        <span style={{ color: "#e4e6eb", fontSize: 12, fontWeight: 700 }}>
                          {livePrice.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: pick.symbol.includes("PEPE") || pick.symbol.includes("SHIB") ? 6 : 2 })}
                          {pick.symbol.includes("-USDT") ? " USDT" : " ₺"}
                        </span>
                      )}
                      <span style={{ color: liveChange >= 0 ? "#ff9f0a" : "#ff453a", fontSize: 11, fontWeight: 800 }}>
                        {liveChange >= 0 ? `+${liveChange.toFixed(2)}%` : `${liveChange.toFixed(2)}%`}
                      </span>
                    </div>
                    <span style={{ color: "#8b949e", fontSize: 10, fontWeight: 600 }}>
                      Hacim: {pick.volSpike.toFixed(1)}x Satış Hacmi Artışı
                    </span>
                  </div>
                </div>

                {/* 4S Sell Confirmation Indicator Pills */}
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 10 }}>
                  <span style={{ background: "rgba(255,69,58,0.12)", color: "#ff453a", padding: "2px 7px", borderRadius: 6, fontSize: 9, fontWeight: 800, border: "1px solid rgba(255,69,58,0.25)" }}>
                    {pick.isEmaDeathCross ? "⚡ 4S DEATH CROSS" : "📉 4S EMA 7 < 21 (AYI)"}
                  </span>
                  <span style={{ background: "rgba(255,69,58,0.08)", color: "#ff9f0a", padding: "2px 7px", borderRadius: 6, fontSize: 9, fontWeight: 700, border: "1px solid rgba(255,159,10,0.2)" }}>
                    MACD: {typeof pick.macd === 'number' ? pick.macd.toFixed(2) : "Negatif"} (SAT)
                  </span>
                  <span style={{ background: "rgba(255,69,58,0.08)", color: "#e4e6eb", padding: "2px 7px", borderRadius: 6, fontSize: 9, fontWeight: 700, border: "1px solid rgba(255,255,255,0.1)" }}>
                    RSI: {Math.round(pick.rsi)} (Direnç Reddi)
                  </span>
                  <span style={{ background: "rgba(255,69,58,0.08)", color: "#ff453a", padding: "2px 7px", borderRadius: 6, fontSize: 9, fontWeight: 700, border: "1px solid rgba(255,69,58,0.2)" }}>
                    SuperTrend: SAT
                  </span>
                </div>
      ...
      {(market === "BIST" || market === "CRYPTO") && smartPicks.length > 0 && (
        <div style={{ marginBottom: 30, background: "linear-gradient(135deg, rgba(0,212,170,0.1), rgba(191,90,242,0.1))", borderRadius: 20, padding: 18, border: "1px solid rgba(0,212,170,0.2)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ color: "#fff", fontSize: 15, fontWeight: 900 }}>AI SMART SEÇİM (4 SAATLİK)</div>
              <div style={{ color: "#00d4aa", fontSize: 10, fontWeight: 700 }}>4S GRAFİK VE BYBIT VERİLERİYLE EN İYİ 2 FIRSAT (LONG & SHORT TEYİTLİ)</div>
            </div>
            <button 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, opacity: isAiLoading ? 0.5 : 1, transition: "opacity 0.3s" }}>
            {smartPicks.map((pick: any, i: number) => {
              const isShort = pick.isShortPick || pick.side === 'short';
              return (
              <div 
                key={i} 
                onClick={() => onSelect(pick)}
                style={{ 
                  ...
                  borderRadius: 16, 
                  padding: 16, 
                  border: isShort ? "1px solid rgba(255,69,58,0.3)" : "1px solid #30363d", 
                  cursor: "pointer" 
                }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <div style={{ 
                      background: isShort ? "rgba(255,69,58,0.15)" : "rgba(48,209,88,0.15)", 
                      color: isShort ? "#ff453a" : "#30d158", 
                      fontSize: 9.5, 
                      fontWeight: 900, 
                      padding: "2px 8px", 
                      borderRadius: 6,
                      border: `1px solid ${isShort ? "rgba(255,69,58,0.35)" : "rgba(48,209,88,0.35)"}`,
                      display: "inline-flex",
                      alignItems: "center",
                      gap: 4
                    }}>
                      {isShort ? "🔴 SHORT / SATIŞ" : "🟢 LONG / ALIM"}
                    </div>
                    <div style={{ background: "rgba(255,255,255,0.05)", color: "#8b949e", fontSize: 9, fontWeight: 700, padding: "2px 6px", borderRadius: 4 }}>
                      {pick.source === 'ALPHA' ? 'ALPHA AI' : pick.source === 'REBOUND' ? (isShort ? 'DİRENÇ DÖNÜŞÜ' : 'DESTEK DÖNÜŞÜ') : pick.source === 'FLOW' ? 'PARA GİRİŞİ' : 'TEKNİK ADAY'}
                    </div>
                  </div>
                  <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "flex-end", gap: 6 }}>
                    <div style={{ background: isShort ? "rgba(255,69,58,0.1)" : "rgba(0,212,170,0.1)", color: isShort ? "#ff453a" : "#00d4aa", fontSize: 10, fontWeight: 800, padding: "2px 8px", borderRadius: 6 }}>{pick.price?.toFixed(2)} {pick.currencySymbol ?? "₺"}</div>
                ...
                <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
                  ...
                  <div style={{ flex: 1, background: "rgba(255,255,255,0.03)", borderRadius: 8, padding: "6px 10px", border: "1px solid #30363d" }}>
                    ...
                    <div style={{ color: isShort ? "#ff453a" : "#00d4aa", fontSize: 11, fontWeight: 800 }}>{pick.volSpike ? `${pick.volSpike.toFixed(1)}x` : "1.2x"}</div>
                  </div>
                  <div style={{ flex: 1, background: "rgba(255,255,255,0.03)", borderRadius: 8, padding: "6px 10px", border: "1px solid #30363d" }}>
                ...
                <div style={{ 
                  background: isShort ? "rgba(255,69,58,0.04)" : "rgba(48,209,88,0.04)", 
                  border: `1px dashed ${isShort ? "rgba(255,69,58,0.3)" : "rgba(0,212,170,0.3)"}`, 
                  borderRadius: 12, 
                  padding: "10px 12px", 
                  marginBottom: 12 
                }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                      ...
                      <span style={{ color: isShort ? "#ff453a" : "#00d4aa", fontSize: 9.5, fontWeight: 900, letterSpacing: 0.5 }}>
                        {isShort ? "4S SHORT DÖNÜŞ GİRİŞİ & YAPISAL SEVİYELER" : "4S LONG ALIM GİRİŞİ & YAPISAL SEVİYELER"}
                      </span>
                    </div>
                    <span style={{ 
                      background: isShort ? "rgba(255,69,58,0.15)" : "rgba(48,209,88,0.15)", 
                      ...
                      {isShort ? "SHORT LİMİT BÖLGESİ" : "LONG LİMİT BÖLGESİ"}
                    </span>
                  </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 8 }}>
                    {isShort ? (
                      <>
                        <div style={{ background: "rgba(255,69,58,0.06)", border: "1px solid rgba(255,69,58,0.2)", borderRadius: 8, padding: "6px 8px" }}>
                          <div style={{ color: "#8b949e", fontSize: 7.5, fontWeight: 800 }}>4S DİRENÇ (LİMİT SHORT GİRİŞ)</div>
                          <div style={{ color: "#ff453a", fontSize: 11, fontWeight: 900 }}>
                            {pick.resistance4h?.toFixed(2)} {pick.currencySymbol ?? "₺"}
                          </div>
                        </div>
                        <div style={{ background: "rgba(48,209,88,0.06)", border: "1px solid rgba(48,209,88,0.2)", borderRadius: 8, padding: "6px 8px" }}>
                          <div style={{ color: "#8b949e", fontSize: 7.5, fontWeight: 800 }}>4S DESTEK (KAR AL / HEDEF)</div>
                      ...
                      <>
                        <div style={{ background: "rgba(48,209,88,0.04)", border: "1px solid rgba(48,209,88,0.12)", borderRadius: 8, padding: "6px 8px" }}>
                          <div style={{ color: "#8b949e", fontSize: 7.5, fontWeight: 800 }}>4S DESTEK (LİMİT ALIM GİRİŞ)</div>
                          <div style={{ color: "#30d158", fontSize: 11, fontWeight: 900 }}>
                            {pick.support4h?.toFixed(2)} {pick.currencySymbol ?? "₺"}
                          </div>
                        </div>
                  ...
                  <div style={{ background: "rgba(0,0,0,0.25)", borderRadius: 6, padding: "6px 8px", fontSize: 9.5, color: "#fff", fontWeight: 600, lineHeight: 1.4, borderLeft: `3.5px solid ${isShort ? "#ff453a" : "#00d4aa"}` }}>
                    <div style={{ color: isShort ? "#ff453a" : "#00d4aa", fontWeight: 800, fontSize: 8.5, marginBottom: 2, letterSpacing: 0.2 }}>
                      {isShort ? "İDEAL SHORT GİRİŞ ARALIĞI (DİRENÇ BÖLGESİ):" : "İDEAL ALIM GİRİŞ ARALIĞI (GÜVENLİ DESTEK):"}
                    </div>
                    {pick.entryRangeMin?.toFixed(2)} - {pick.entryRangeMax?.toFixed(2)} {pick.currencySymbol ?? "₺"}
                  </div>
                  
                  <div style={{ color: isShort ? "#ff7b72" : "#ff9500", fontSize: 9, fontWeight: 600, marginTop: 6, display: "flex", gap: 4, alignItems: "center", lineHeight: 1.3 }}>
                    <span>⚠️</span>
                    <span>{pick.entryAdvice}</span>
                  </div>
                </div>
                ...
                {market === "CRYPTO" && pick.topTraderRatio ? (
                  <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 12 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <div style={{ fontSize: 9, fontWeight: 800, color: "#8b949e", letterSpacing: 0.5 }}>BYBIT TOP 100 TRADERS L/S ORANI (4S)</div>
                      <div style={{
                        fontSize: 8.5,
                        fontWeight: 900,
                        color: pick.topTraderRatio.isShortSqueeze ? "#ff9f0a" : pick.topTraderRatio.isOverLong ? "#ff453a" : pick.topTraderRatio.isStrongWhaleLong ? "#30d158" : "#8b949e",
                        background: pick.topTraderRatio.isShortSqueeze ? "rgba(255,159,10,0.15)" : pick.topTraderRatio.isOverLong ? "rgba(255,69,58,0.15)" : pick.topTraderRatio.isStrongWhaleLong ? "rgba(48,209,88,0.15)" : "rgba(255,255,255,0.05)",
                        padding: "2px 6px",
                        borderRadius: 4
                      }}>
                        {pick.topTraderRatio.determinationLabel}
                      </div>
                    </div>
                    <div style={{ width: "100%", height: 6, background: "rgba(255,255,255,0.05)", borderRadius: 3, display: "flex", overflow: "hidden" }}>
                      <div style={{ width: `${pick.topTraderRatio.buyRatio}%`, background: "linear-gradient(90deg, #00d4aa, #00b8ff)", height: "100%" }}></div>
                      <div style={{ width: `${pick.topTraderRatio.sellRatio}%`, background: "#ff453a", height: "100%", opacity: 0.9 }}></div>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9, fontWeight: 700 }}>
                      <div style={{ color: "#00d4aa" }}>Top 100 Long: %{pick.topTraderRatio.buyRatio.toFixed(1)}</div>
                      <div style={{ color: "#ff453a" }}>Top 100 Short: %{pick.topTraderRatio.sellRatio.toFixed(1)}</div>
                    </div>
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 12 }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9, fontWeight: 700 }}>
                      <div style={{ color: "#00d4aa" }}>Kurumsal: %{pick.institutionalRatio.toFixed(1)}</div>
...
function CandidatesScreen({ candidates = [], prices = {}, lastUpdated, onBack, onSelect, market }: any) {
  ...
  return (
    <div style={{ padding: "0 0 20px" }}>
      ...
      if (!Number.isFinite(currentChange)) currentChange = 0;
      const pd = stock.pd || getAdjustedTechnicals(stock.symbol, currentChange);
      let price = Number(REAL_CRYPTO_LIVE_PRICES[stock.symbol]?.price ?? prices[stock.symbol] ?? stock.price ?? REALISTIC_CRYPTO_PRICES[stock.symbol] ?? 0);
      if (!Number.isFinite(price) || price === 0) {
        if (!stock.symbol.includes("-USDT")) {
          const seed = getSymbolSeed(stock.symbol);
          price = 10 + (seed % 500);
        } else {
          price = 0;
        ...
        >
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
            <div style={{ flex: 1.2, background: isShort ? "rgba(255,69,58,0.1)" : "rgba(48,209,88,0.1)", borderRadius: 16, padding: "12px 16px", border: `1px solid ${isShort ? "rgba(255,69,58,0.3)" : "rgba(48,209,88,0.3)"}` }}>
              <div style={{ color: isShort ? "#ff453a" : "#30d158", fontSize: 10, fontWeight: 800, letterSpacing: 0.5, marginBottom: 4 }}>TP (1H AI HEDEF)</div>
            ...
            <div style={{ flex: 1, background: "rgba(255,214,10,0.1)", borderRadius: 16, padding: "12px 16px", border: "1px solid rgba(255,214,10,0.3)" }}>
              <div style={{ color: "#ffd60a", fontSize: 10, fontWeight: 800, letterSpacing: 0.5, marginBottom: 4 }}>{isShort ? "1H AI DİRENÇ" : "1H AI DESTEK"}</div>
...
function DetailScreen({ stock, prices, patternData: initialPd, aiAnalysis, aiLoading, onFetchAi, kapNews, tab, setTab, timeframe, setTimeframe, onBack }: any) {
  ...
  // Cache lookups
  const cachedLive = REAL_CRYPTO_LIVE_PRICES[stock.symbol];
  const cachedTech = REAL_TECHNICALS_CACHE[stock.symbol];

  const getResolvedPrice = () => {
    if (cachedLive && cachedLive.price > 0) return cachedLive.price;
    const pVal = Number(prices[stock.symbol]);
    if (pVal && pVal > 0) return pVal;
    const techPrice = Number((cachedTech as any)?.price || (cachedTech as any)?.lastPrice);
    if (techPrice && techPrice > 0) return techPrice;
    const sPrice = Number(stock.price);
    if (sPrice && sPrice > 0) return sPrice;
    if (isCrypto && REALISTIC_CRYPTO_PRICES[stock.symbol]) return REALISTIC_CRYPTO_PRICES[stock.symbol];
    return 0;
  };

  const getResolvedChange = () => {
    if (cachedLive && Number.isFinite(cachedLive.change)) return cachedLive.change;
    const pCh = Number(prices[`${stock.symbol}_change`]);
    if (Number.isFinite(pCh)) return pCh;
    const sCh = Number(stock.change);
    if (Number.isFinite(sCh)) return sCh;
    return 0;
  };

  const [livePrice, setLivePrice] = useState<number>(getResolvedPrice);
  const [liveChange, setLiveChange] = useState<number>(getResolvedChange);
  const [liveSource, setLiveSource] = useState<string>(() => 
    prices[`${stock.symbol}_source`] || (isCrypto ? "BYBIT" : "CANLI VERİ")
  );

  // Active Bybit refresh on mount or symbol change
  useEffect(() => {
    let isMounted = true;
    if (isCrypto) {
      const cleanSym = stock.symbol.replace("-USDT", "USDT");
      // 1. Fetch server-side technicals (uses Bybit Linear & Spot klines)
      fetch(`/api/crypto/technicals?symbol=${encodeURIComponent(stock.symbol)}`)
        .then(r => r.json())
        .then(d => {
          if (!isMounted) return;
          if (d && d.price && d.price > 0) {
            ...
            setLiveSource("BYBIT");
            REAL_CRYPTO_LIVE_PRICES[stock.symbol] = { price: d.price, change: d.change24h ?? liveChange, source: "BYBIT" };
          }
        })
        .catch(() => {});

      // 2. Direct Bybit v5 ticker (native CORS)
      fetch(`https://api.bybit.com/v5/market/tickers?category=linear&symbol=${cleanSym}`)
        .then(r => r.json())
        .then(d => {
          if (!isMounted) return;
          ...
          if (t && t.lastPrice) {
            ...
            const ch = parseFloat((parseFloat(t.price24hPcnt || "0") * 100).toFixed(2));
            if (!isNaN(p) && p > 0) {
              setLivePrice(p);
              setLiveChange(ch);
              setLiveSource("BYBIT");
              REAL_CRYPTO_LIVE_PRICES[stock.symbol] = { price: p, change: ch, source: "BYBIT" };
            }
          }
        })
        .catch(() => {});
  ...
  }, [stock.symbol, isCrypto]);

  // Keep synced with prices state updates from background worker
  useEffect(() => {
    const pVal = Number(prices[stock.symbol]);
    if (pVal && pVal > 0) {
      setLivePrice(pVal);
    ...
    const pCh = Number(prices[`${stock.symbol}_change`]);
    if (Number.isFinite(pCh)) {
      setLiveChange(pCh);
    }
  }, [prices, stock.symbol]);

  const price = livePrice;
  const currentChange = liveChange;
  const up = currentChange >= 0;
  ...
  const chartData = useMemo(() => {
    const cachedTech = REAL_TECHNICALS_CACHE[stock.symbol];
    if (isCrypto && cachedTech?.klines && cachedTech.klines.length > 0) {
      return cachedTech.klines;
    }
    return generateCandleData(price, 60, stock.symbol, timeframe);
  }, [stock.symbol, price, timeframe, isCrypto]);
  ...
  if (!Number.isFinite(potential) || potential <= 0) {
    potential = Math.round(Math.abs((level2 / (price || 1)) * 100));
  }
  ...
  const tp1Perc = +Math.abs(((tp1 - price) / (price || 1)) * 100).toFixed(1);
  const tp2Perc = +Math.abs(((tp2 - price) / (price || 1)) * 100).toFixed(1);
  const tp3Perc = +Math.abs(((tp3 - price) / (price || 1)) * 100).toFixed(1);
  const slPerc = +Math.abs(((sl - price) / (price || 1)) * 100).toFixed(1);
  ...
  <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      ...
      <div style={{ background: isShort ? "rgba(255,69,58,0.2)" : "rgba(0,212,170,0.2)", color: sideColor, fontSize: 13, fontWeight: 800, padding: "4px 14px", borderRadius: 12, border: `1px solid ${sideColor}55` }}>
        {isCrypto ? (isShort ? "SHORT HEDEFİ %" : "LONG HEDEFİ %") : "HEDEF KAR %"} {Math.round(potential)}
      </div>
    </div>
    ...
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 12 }}>
      <div>
        <div style={{ color: "#fff", fontSize: 36, fontWeight: 900, letterSpacing: -0.5 }}>
          {price > 0 ? `${price.toFixed(pricePrecision)} ${currency}` : `Yükleniyor...`}
        </div>
      ...
      <div style={{ textAlign: "right", paddingBottom: 4 }}>
        ...
        <div style={{ color: "#8b949e", fontSize: 11, fontWeight: 700 }}>
          {isCrypto ? "📡 BYBIT API" : (prices[`${stock.symbol}_source`] ? `📡 ${prices[`${stock.symbol}_source`].toUpperCase()}` : "📡 CANLI VERİ")}
        </div>
      </div>
    </div>
  </div>
...
{isCrypto && (
  <div style={{ marginBottom: 14 }}>
    <BybitCoinBadge symbol={stock.symbol} />
  </div>
)}
</div>
  ...
  <div style={{ padding: "14px 16px 0" }}>
    ...
    <div style={{ background: "#161b22", borderRadius: 16, padding: "10px 0 5px", border: "1px solid #30363d" }}>
      <div style={{ display: "flex", gap: 10, paddingLeft: 14, marginBottom: 4, alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <div style={{ color: "#8b949e", fontSize: 8, fontWeight: 700 }}>{isCrypto ? "EMA 7" : "SMA 20"}</div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          <div style={{ width: 8, height: 2, background: "#5e5ce6" }} />
          <div style={{ color: "#8b949e", fontSize: 8, fontWeight: 700 }}>{isCrypto ? "EMA 21" : "EMA 50"}</div>
        </div>
        {isCrypto && REAL_TECHNICALS_CACHE[stock.symbol]?.isRealData && (
          <div style={{ marginLeft: "auto", paddingRight: 14, color: "#30d158", fontSize: 8, fontWeight: 700 }}>
            ✓ Canlı Bybit API
          </div>
        )}
      </div>
      ...
      <div style={{ marginTop: 12, background: "linear-gradient(135deg, #21262d 0%, #161b22 100%)", borderRadius: 16, padding: 14, border: "1px solid rgba(0,212,170,0.3)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
          <div style={{ color: "#00d4aa", fontSize: 13, fontWeight: 700 }}>⚡ 4S & 1S Trend & Yapı Analizi</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          {[
            ...
            { label: `TP1 (1S ${isShort ? "Destek" : "Direnç"})`, val: `${tp1} ${currency}`, color: "#30d158", bg: "rgba(48,209,88,0.08)" },
            { label: `TP2 (4S Ana ${isShort ? "Destek" : "Direnç"})`, val: `${tp2} ${currency}`, color: "#30d158", bg: "rgba(48,209,88,0.08)" },
            { label: `STOP LOSS (4S ${isShort ? "Direnç Üstü" : "Destek Altı"})`, val: `${sl} ${currency}`, color: "#ff453a", bg: "rgba(255,69,58,0.08)" },
            { label: `TP3 (Günlük Trend)`, val: `${tp3} ${currency}`, color: "#30d158", bg: "rgba(48,209,88,0.08)" },
          ].map(t => (
      ...
      {isCrypto && REAL_TECHNICALS_CACHE[stock.symbol] && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 8 }}>
          <div style={{ background: "rgba(255,159,10,0.06)", borderRadius: 10, padding: "8px 10px", border: "1px solid rgba(255,159,10,0.2)" }}>
            <div style={{ color: "#8b949e", fontSize: 8.5, fontWeight: 700 }}>4S EMA 7</div>
            <div style={{ color: "#ff9f0a", fontSize: 12, fontWeight: 800 }}>{REAL_TECHNICALS_CACHE[stock.symbol].ema7?.toFixed(pricePrecision)}</div>
          </div>
          <div style={{ background: "rgba(191,90,242,0.06)", borderRadius: 10, padding: "8px 10px", border: "1px solid rgba(191,90,242,0.2)" }}>
            <div style={{ color: "#8b949e", fontSize: 8.5, fontWeight: 700 }}>4S EMA 21</div>
            <div style={{ color: "#bf5af2", fontSize: 12, fontWeight: 800 }}>{REAL_TECHNICALS_CACHE[stock.symbol].ema21?.toFixed(pricePrecision)}</div>
          </div>
          <div style={{ background: "rgba(94,92,230,0.06)", borderRadius: 10, padding: "8px 10px", border: "1px solid rgba(94,92,230,0.2)" }}>
            <div style={{ color: "#8b949e", fontSize: 8.5, fontWeight: 700 }}>4S EMA 50</div>
            <div style={{ color: "#5e5ce6", fontSize: 12, fontWeight: 800 }}>{REAL_TECHNICALS_CACHE[stock.symbol].ema50?.toFixed(pricePrecision)}</div>
          </div>
        </div>
      )}
      ...
      <div style={{ background: "#131922", borderRadius: 18, padding: 16, border: "1px solid #1a2535" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          <div>
            ...
            <div style={{ color: "#8b949e", fontSize: 10 }}>4 Saatlik Bybit İndikatörleri + FIB (Eşit Ağırlıklı Model)</div>
          </div>
      ...
      <div style={{ background: "linear-gradient(135deg, #0d1420, #0a0e1a)", borderRadius: 18, padding: 16, border: "1px solid #1a2535" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
          ...
          <div>
            ...
            <div style={{ color: "#4a5568", fontSize: 10 }}>Gemini 3.8 Flash • 4 Saatlik</div>
          </div>
        </div>
        {aiLoading ? (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ textAlign: "center", padding: "10px 0" }}>
            ...
            <div style={{ color: "#4a5568", fontSize: 10, marginTop: 8 }}>Gemini 3.8 Flash ile 4 saatlik derin teknik analiz</div>
          </div>
        )}
      </div>
    </div>
...
const navItems = [
  ...
  { key: "whale", icon: "🐋", label: "Bybit L/S" },
...
function EmailAlertsModal({ onClose }: { onClose: () => void }) {
  const [email, setEmail] = useState(() => {
    return localStorage.getItem("crypto_alert_email") || "yunusbalcik@gmail.com";
  });
  const [newTrendAlert, setNewTrendAlert] = useState(true);
  const [strongTrendAlert, setStrongTrendAlert] = useState(true);
  const [shortReversalAlert, setShortReversalAlert] = useState(true);
  const [scalpBreakoutAlert, setScalpBreakoutAlert] = useState(true);
  const [frequency, setFrequency] = useState<"instant" | "hourly">("instant");
  
  const [toastMessage, setToastMessage] = useState<string | null>(null);
  const [isTestSending, setIsTestSending] = useState(false);

  const handleSave = () => {
    localStorage.setItem("crypto_alert_email", email);
    localStorage.setItem("crypto_email_alerts_config", JSON.stringify({
      email,
      newTrendAlert,
      strongTrendAlert,
      shortReversalAlert,
    ...
    setToastMessage("✅ E-Posta alarm tercihleri başarıyla kaydedildi ve aktif edildi!");
    setTimeout(() => {
  ...
  const handleTestMail = () => {
    if (!email || !email.includes("@")) {
      setToastMessage("⚠️ Lütfen geçerli bir e-posta adresi giriniz.");
      return;
    }
    ...
    setTimeout(() => {
      ...
      setToastMessage(`📧 Test E-Postası "${email}" adresine başarıyla gönderildi!\n\nÖrnek İçerik:\n⚡ [TAZE BOĞA SİNYALİ] FET (Fetch.ai) %96 Güç Skoru ile Fib %61.8 Direncini Kırdı! (Giriş: 1.28 USDT | Stop: 1.21 USDT)`);
    }, 1200);
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: "100%", maxWidth: 440, borderRadius: 24, border: "1px solid rgba(0,212,170,0.3)",
        padding: 24, boxShadow: "0 20px 50px rgba(0,0,0,0.6)", position: "relative",
        maxHeight: "90vh", overflowY: "auto"
      }}>
        {/* Header */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 40, height: 40, borderRadius: 12, background: "linear-gradient(135deg, #00d4aa, #bf5af2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}>
              🔔
            </div>
            <div>
              <div style={{ color: "#fff", fontSize: 16, fontWeight: 900 }}>E-POSTA ALARM SİSTEMİ</div>
              <div style={{ color: "#00d4aa", fontSize: 10, fontWeight: 800 }}>TAZE SİNYAL & YENİ COIN BİLDİRİMLERİ</div>
            </div>
          </div>
          <button onClick={onClose} style={{ background: "rgba(255,255,255,0.08)", border: "none", color: "#8b949e", width: 32, height: 32, borderRadius: "50%", fontSize: 16, cursor: "pointer" }}>
            ✕
          </button>
        </div>
        ...
        <div style={{ marginBottom: 20 }}>
          <label style={{ display: "block", color: "#8b949e", fontSize: 10, fontWeight: 800, marginBottom: 8, letterSpacing: 0.5 }}>
            BİLDİRİM GÖNDERİLECEK E-POSTA ADRESİ:
          </label>
          <input
            type="email"
            value={email}
            ...
            style={{
              width: "100%", background: "#0d1117", border: "1px solid rgba(0,212,170,0.3)",
              color: "#fff", padding: "12px 16px", borderRadius: 12, fontSize: 14, fontWeight: 700,
              outline: "none"
            }}
          />
        </div>
        ...
        {/* Alarm Toggles */}
        <div style={{ marginBottom: 20 }}>
          <div style={{ color: "#8b949e", fontSize: 10, fontWeight: 800, marginBottom: 10, letterSpacing: 0.5 }}>
            BİLDİRİM ALINACAK SİNYAL TİPLERİ:
          </div>

          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[
              { id: "newTrend", label: "🚀 Yeni Başlayan Trendler (Golden Cross)", desc: "1S/2S onaylı taze boğa momentumu gösteren coinler", state: newTrendAlert, setState: setNewTrendAlert },
              { id: "strongTrend", label: "🔥 Güçlü Trendler (%96+ Güç Skoru)", desc: "Piyasa lideri ve yüksek hacimli fırsatlar", state: strongTrendAlert, setState: setStrongTrendAlert },
              { id: "shortReversal", label: "📉 Direnç Dönüşü (Short & Hacimli Satış)", desc: "Dirençten tepki veren short fırsatları", state: shortReversalAlert, setState: setShortReversalAlert },
              { id: "scalpBreakout", label: "⚡ Hızlı Scalp & Ani Hacim Kırılımları", desc: "Anlık hacim patlaması yaşayan varlıklar", state: scalpBreakoutAlert, setState: setScalpBreakoutAlert },
            ].map(item => (
              <div
                key={item.id}
                ...
                style={{
                  ...
                  background: item.state ? "rgba(0,212,170,0.06)" : "rgba(255,255,255,0.02)",
                  border: item.state ? "1px solid rgba(0,212,170,0.3)" : "1px solid rgba(255,255,255,0.05)",
                  borderRadius: 14, padding: "12px 14px", cursor: "pointer", transition: "all 0.2s"
                }}
              >
                <div>
                  <div style={{ color: item.state ? "#fff" : "#8b949e", fontSize: 12, fontWeight: 800 }}>{item.label}</div>
                  <div style={{ color: "#6b7280", fontSize: 10, marginTop: 2 }}>{item.desc}</div>
                </div>
                <div style={{
                  width: 42, height: 22, borderRadius: 12,
                  background: item.state ? "#00d4aa" : "#30363d",
                  position: "relative", transition: "all 0.2s", flexShrink: 0
                }}>
                  <div style={{
                    width: 16, height: 16, borderRadius: "50%", background: "#fff",
                    position: "absolute", top: 3, left: item.state ? 23 : 3, transition: "all 0.2s"
                  }} />
                </div>
              </div>
            ))}
        ...
        {/* Frequency selector */}
        <div style={{ marginBottom: 20 }}>
          <div style={{ color: "#8b949e", fontSize: 10, fontWeight: 800, marginBottom: 8, letterSpacing: 0.5 }}>
            BİLDİRİM SIKLIĞI:
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            <button
              ...
              style={{
                ...
                background: frequency === "instant" ? "linear-gradient(135deg, #00d4aa, #00b8ff)" : "#21262d",
                color: frequency === "instant" ? "#000" : "#8b949e",
            ...
            <button
              ...
              style={{
                padding: "10px", borderRadius: 12, border: "none", cursor: "pointer",
                background: frequency === "hourly" ? "linear-gradient(135deg, #00d4aa, #00b8ff)" : "#21262d",
                color: frequency === "hourly" ? "#000" : "#8b949e",
                fontSize: 11, fontWeight: 800
              }}
            >
              ⏰ Saatlik Özet Raporu
        ...
        {toastMessage && (
          <div style={{
            ...
            borderRadius: 12, padding: 12, color: "#fff", fontSize: 11, fontWeight: 600,
            lineHeight: 1.5, marginBottom: 16, whiteSpace: "pre-wrap"
          }}>
            {toastMessage}
          </div>
        )}
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          >
            {isTestSending ? "Gönderiliyor..." : "✉️ Test Maili"}
          </button>
          <button
            onClick={handleSave}
            style={{
              flex: 1.2, padding: "12px", borderRadius: 14,
              background: "linear-gradient(135deg, #00d4aa, #00b8ff)", color: "#000",
